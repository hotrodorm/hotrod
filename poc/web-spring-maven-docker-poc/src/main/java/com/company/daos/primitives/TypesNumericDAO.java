...
import com.company.daos.TypesNumericVO;
...
public class TypesNumericDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.daos.TypesNumericVO> selectByExample(final com.company.daos.TypesNumericVO example, final TypesNumericOrderBy... orderBies)
      {
    DaoWithOrder<com.company.daos.TypesNumericVO, TypesNumericOrderBy> dwo = //
        new DaoWithOrder<com.company.daos.TypesNumericVO, TypesNumericOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.daos.primitives.typesNumeric.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.daos.TypesNumericVO> selectByCriteria(final TypesNumericDAO.TypesNumericTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.daos.TypesNumericVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.daos.primitives.typesNumeric.selectByCriteria");
  }

  // insert

  public int insert(final com.company.daos.TypesNumericVO vo) {
    return insert(vo, false);
  }

  public int insert(final com.company.daos.TypesNumericVO vo, final boolean retrieveDefaults) {
    String id = retrieveDefaults ? "com.company.daos.primitives.typesNumeric.insertRetrievingDefaults" : "com.company.daos.primitives.typesNumeric.insert";
  ...
  public int updateByExample(final com.company.daos.TypesNumericVO example, final com.company.daos.TypesNumericVO updateValues) {
    UpdateByExampleDao<com.company.daos.TypesNumericVO> fvd = //
      new UpdateByExampleDao<com.company.daos.TypesNumericVO>(example, updateValues);
    return this.sqlSession.update("com.company.daos.primitives.typesNumeric.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.daos.TypesNumericVO example) {
    return this.sqlSession.delete("com.company.daos.primitives.typesNumeric.deleteByExample", example);
  }
