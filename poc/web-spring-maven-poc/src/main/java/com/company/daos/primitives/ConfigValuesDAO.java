...
import com.company.daos.ConfigValuesVO;
...
public class ConfigValuesDAO implements Serializable, ApplicationContextAware {
  ...
  public com.company.daos.ConfigValuesVO  selectByUIName(final java.lang.String name) {
    if (name == null)
      return null;
    com.company.daos.ConfigValuesVO vo = new com.company.daos.ConfigValuesVO();
    vo.setName(name);
    return this.sqlSession.selectOne("com.company.daos.primitives.configValues.selectByUIName", vo);
  }

  public com.company.daos.ConfigValuesVO  selectByUINodeCell(final java.lang.Integer node, final java.lang.Integer cell) {
    if (node == null)
      return null;
    if (cell == null)
      return null;
    ...
    vo.setNode(node);
    vo.setCell(cell);
    return this.sqlSession.selectOne("com.company.daos.primitives.configValues.selectByUINodeCell", vo);
  }

  // select by example

  public List<com.company.daos.ConfigValuesVO> selectByExample(final com.company.daos.ConfigValuesVO example, final ConfigValuesOrderBy... orderBies)
      {
    DaoWithOrder<com.company.daos.ConfigValuesVO, ConfigValuesOrderBy> dwo = //
        new DaoWithOrder<com.company.daos.ConfigValuesVO, ConfigValuesOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.daos.primitives.configValues.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.daos.ConfigValuesVO> selectByCriteria(final ConfigValuesDAO.ConfigValuesTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.daos.ConfigValuesVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.daos.primitives.configValues.selectByCriteria");
  }

  // insert

  public int insert(final com.company.daos.ConfigValuesVO vo) {
    String id = "com.company.daos.primitives.configValues.insert";
  ...
  public int updateByExample(final com.company.daos.ConfigValuesVO example, final com.company.daos.ConfigValuesVO updateValues) {
    UpdateByExampleDao<com.company.daos.ConfigValuesVO> fvd = //
      new UpdateByExampleDao<com.company.daos.ConfigValuesVO>(example, updateValues);
    return this.sqlSession.update("com.company.daos.primitives.configValues.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.daos.ConfigValuesVO example) {
    return this.sqlSession.delete("com.company.daos.primitives.configValues.deleteByExample", example);
  }
