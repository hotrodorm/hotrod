...
public class DomainTestIdentity2Prototype implements Serializable {
  ...
  protected java.lang.Integer id2 = null;
  ...
  public final java.lang.Integer getId2() {
    return this.id2;
  }

  public final void setId2(final java.lang.Integer id2) {
    this.id2 = id2;
    this.getPropertiesChangeLog().id2WasSet = true;
  }
  ...
  protected class PropertiesChangeLog {
    ...
    public boolean id2WasSet = false;
