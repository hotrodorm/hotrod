...
public class DomainIslandPrototype implements Serializable {
  ...
  public final void setSegment(final java.lang.Integer segment) {
    this.segment = segment;
    this.getPropertiesChangeLog().segmentWasSet = true;
  }

  public final java.lang.Integer getXStart() {
    return this.xStart;
  }

  public final void setXStart(final java.lang.Integer xStart) {
    this.xStart = xStart;
    this.getPropertiesChangeLog().xStartWasSet = true;
  }

  public final java.lang.Integer getXEnd() {
    return this.xEnd;
  }

  public final void setXEnd(final java.lang.Integer xEnd) {
    this.xEnd = xEnd;
  ...
  public final void setHeight(final java.lang.Integer height) {
    this.height = height;
