...
import com.company.cli.maven_test.daos.ApplicationConfigVO;
...
public class ApplicationConfigDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.cli.maven_test.daos.ApplicationConfigVO> selectByExample(final com.company.cli.maven_test.daos.ApplicationConfigVO example, final ApplicationConfigOrderBy... orderBies)
      {
    DaoWithOrder<com.company.cli.maven_test.daos.ApplicationConfigVO, ApplicationConfigOrderBy> dwo = //
        new DaoWithOrder<com.company.cli.maven_test.daos.ApplicationConfigVO, ApplicationConfigOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.cli.maven_test.daos.primitives.applicationConfig.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.cli.maven_test.daos.ApplicationConfigVO> selectByCriteria(final ApplicationConfigDAO.ApplicationConfigTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.cli.maven_test.daos.ApplicationConfigVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.cli.maven_test.daos.primitives.applicationConfig.selectByCriteria");
  }

  // insert

  public int insert(final com.company.cli.maven_test.daos.ApplicationConfigVO vo) {
    String id = "com.company.cli.maven_test.daos.primitives.applicationConfig.insert";
  ...
  public int updateByExample(final com.company.cli.maven_test.daos.ApplicationConfigVO example, final com.company.cli.maven_test.daos.ApplicationConfigVO updateValues) {
    UpdateByExampleDao<com.company.cli.maven_test.daos.ApplicationConfigVO> fvd = //
      new UpdateByExampleDao<com.company.cli.maven_test.daos.ApplicationConfigVO>(example, updateValues);
    return this.sqlSession.update("com.company.cli.maven_test.daos.primitives.applicationConfig.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.cli.maven_test.daos.ApplicationConfigVO example) {
    return this.sqlSession.delete("com.company.cli.maven_test.daos.primitives.applicationConfig.deleteByExample", example);
  }
