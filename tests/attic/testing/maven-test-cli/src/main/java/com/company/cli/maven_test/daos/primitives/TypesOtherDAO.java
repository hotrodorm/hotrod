...
public class TypesOtherDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.cli.maven_test.daos.TypesOtherVO> selectByExample(final com.company.cli.maven_test.daos.TypesOtherVO example, final TypesOtherOrderBy... orderBies)
      {
    DaoWithOrder<com.company.cli.maven_test.daos.TypesOtherVO, TypesOtherOrderBy> dwo = //
        new DaoWithOrder<com.company.cli.maven_test.daos.TypesOtherVO, TypesOtherOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.cli.maven_test.daos.primitives.typesOther.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.cli.maven_test.daos.TypesOtherVO> selectByCriteria(final TypesOtherDAO.TypesOtherTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.cli.maven_test.daos.TypesOtherVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.cli.maven_test.daos.primitives.typesOther.selectByCriteria");
  }

  // insert

  public int insert(final com.company.cli.maven_test.daos.TypesOtherVO vo) {
    String id = "com.company.cli.maven_test.daos.primitives.typesOther.insert";
  ...
  public int updateByExample(final com.company.cli.maven_test.daos.TypesOtherVO example, final com.company.cli.maven_test.daos.TypesOtherVO updateValues) {
    UpdateByExampleDao<com.company.cli.maven_test.daos.TypesOtherVO> fvd = //
      new UpdateByExampleDao<com.company.cli.maven_test.daos.TypesOtherVO>(example, updateValues);
    return this.sqlSession.update("com.company.cli.maven_test.daos.primitives.typesOther.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.cli.maven_test.daos.TypesOtherVO example) {
    return this.sqlSession.delete("com.company.cli.maven_test.daos.primitives.typesOther.deleteByExample", example);
  }
