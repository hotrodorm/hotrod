...
public class DomainItemPrototype implements Serializable {
  ...
  public final void setIcon(final byte[] icon) {
    this.icon = icon;
    this.getPropertiesChangeLog().iconWasSet = true;
  }

  public final java.lang.Object getStoreCode() {
    return this.storeCode;
  }

  public final void setStoreCode(final java.lang.Object storeCode) {
