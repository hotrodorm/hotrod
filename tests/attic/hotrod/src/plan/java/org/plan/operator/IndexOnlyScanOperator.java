...
public class IndexOnlyScanOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "INDEX ONLY SCAN";

  public IndexOnlyScanOperator(final T id, final String specificName, final SourceSet sourceSet,
