...
import com.company.daos.ItemVO;
...
public class ItemDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.daos.ItemVO> selectByExample(final com.company.daos.ItemVO example, final ItemOrderBy... orderBies)
      {
    DaoWithOrder<com.company.daos.ItemVO, ItemOrderBy> dwo = //
        new DaoWithOrder<com.company.daos.ItemVO, ItemOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.daos.primitives.item.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.daos.ItemVO> selectByCriteria(final ItemDAO.ItemTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.daos.ItemVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.daos.primitives.item.selectByCriteria");
  }

  // insert

  public int insert(final com.company.daos.ItemVO vo) {
    String id = "com.company.daos.primitives.item.insert";
  ...
  public int updateByExample(final com.company.daos.ItemVO example, final com.company.daos.ItemVO updateValues) {
    UpdateByExampleDao<com.company.daos.ItemVO> fvd = //
      new UpdateByExampleDao<com.company.daos.ItemVO>(example, updateValues);
    return this.sqlSession.update("com.company.daos.primitives.item.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.daos.ItemVO example) {
    return this.sqlSession.delete("com.company.daos.primitives.item.deleteByExample", example);
  }
