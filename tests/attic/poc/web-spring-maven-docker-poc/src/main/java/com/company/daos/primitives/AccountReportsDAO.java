...
import com.company.daos.AccountVolumeVO;
import com.company.daos.OldAccountVolumeVO;
...
public class AccountReportsDAO implements Serializable, ApplicationContextAware {
  ...
  */
  ...
  public int applyPromotion(final Integer minAmount, final Integer prize) {
    ...
    return this.sqlSession.update(
      "com.company.daos.primitives.accountReportsDAO.applyPromotion", param0);
  }
  ...
  */
  ...
  public List<AccountVolumeVO> selectNewAccountsVolume() {
    return this.sqlSession.selectList("com.company.daos.primitives.accountReportsDAO.select_selectNewAccountsVolume");
  }
  ...
  */
  ...
  public List<OldAccountVolumeVO> selectOldAccountsVolume() {
    return this.sqlSession.selectList("com.company.daos.primitives.accountReportsDAO.select_selectOldAccountsVolume");
  }
