...
import com.company.daos.LowAccountVO;
...
public class LowAccountDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.daos.LowAccountVO> selectByExample(final com.company.daos.LowAccountVO example, final LowAccountOrderBy... orderBies)
      {
    DaoWithOrder<com.company.daos.LowAccountVO, LowAccountOrderBy> dwo = //
        new DaoWithOrder<com.company.daos.LowAccountVO, LowAccountOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.daos.primitives.lowAccount.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.daos.LowAccountVO> selectByCriteria(final LowAccountDAO.LowAccountView from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.daos.LowAccountVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.daos.primitives.lowAccount.selectByCriteria");
  }

  // insert by example

  public int insertByExample(final com.company.daos.LowAccountVO example) {
    return sqlSession.insert("com.company.daos.primitives.lowAccount.insertByExample", example);
  }

  // update by example

  public int updateByExample(final com.company.daos.LowAccountVO example, final com.company.daos.LowAccountVO updateValues) {
    UpdateByExampleDao<com.company.daos.LowAccountVO> fvd = //
      new UpdateByExampleDao<com.company.daos.LowAccountVO>(example, updateValues);
    return this.sqlSession.update("com.company.daos.primitives.lowAccount.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.daos.LowAccountVO example) {
    return this.sqlSession.delete("com.company.daos.primitives.lowAccount.deleteByExample", example);
  }
