...
public class K4DAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final GeneratedKeysInsertExecutor<Long> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysIdentityInlineResultSetInsertExecutor<Long>(
        KeyReader.LONG_KEY_READER, MetaData.ID.getCanonicalName());
  ...
  public static class K4Table extends TableWithGeneratedKey<K4, Long> {
    ...
    K4Table() {
      super(null, null, Name.of("K4", false), "Table", null, K4Layout.class, K4.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    K4Table(final String alias) {
      super(null, null, Name.of("K4", false), "Table", alias, K4Layout.class, K4.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
