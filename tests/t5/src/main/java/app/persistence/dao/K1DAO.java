...
@Component
public class K1DAO implements ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final DirectEntityColumnMetaData ID_META_DATA = new DirectEntityColumnMetaData(
      Name.of("ID", false), "id", "TINYINT", 8, 0, TypeHandler.forClass(Byte.class, TypeSource.STATIC_DIALECT_RULE, "D7"));
    ...
    static final GeneratedKeysInsertExecutor<Byte> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysIdentityInlineResultSetInsertExecutor<Byte>(
        KeyReader.BYTE_KEY_READER, MetaData.ID_META_DATA.getName().getName());
