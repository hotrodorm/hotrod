...
import app.persistence.model.K3;
...
public class K3DAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final GeneratedKeysInsertExecutor<Integer> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysIdentityInlineResultSetInsertExecutor<Integer>(
        KeyReader.INTEGER_KEY_READER, MetaData.ID.getCanonicalName());
  ...
  public static class K3Table extends TableWithGeneratedKey<K3, Integer> {
    ...
    K3Table() {
      super(null, null, Name.of("K3", false), "Table", null, K3Layout.class, K3.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    K3Table(final String alias) {
      super(null, null, Name.of("K3", false), "Table", alias, K3Layout.class, K3.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
