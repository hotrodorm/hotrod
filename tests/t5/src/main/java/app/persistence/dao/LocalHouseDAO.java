...
public class LocalHouseDAO implements ApplicationContextAware {
  ...
  private void initializeUpdatebypk() {
    this.updateByPK = dyn
      ...
      .literaln("SET")
      .trim("  ", ",\n  ","\n")
        .begin().literal("zip_code = ").parameterNullable("m.zipCode", Types.VARCHAR).end()
        .begin().literal("\"zip_code\" = ").parameterNullable("m.zipKode3", Types.VARCHAR).end()
        .begin().literal("\"Zip_Code\" = ").parameterNullable("m.zipKode2", Types.VARCHAR).end()
        .begin().literal("name = ").parameterNullable("m.name", Types.VARCHAR).end()
      .endtrim()
  ...
  static class MetaData {
    ...
    static final DirectEntityColumnMetaData ID_META_DATA = new DirectEntityColumnMetaData(
      Name.of("ID", false), "id", "BIGINT", 64, 0, TypeHandler.forClass(Long.class, TypeSource.STATIC_DIALECT_RULE, "D10"));
    static final DirectEntityColumnMetaData ZIP_CODE_META_DATA = new DirectEntityColumnMetaData(
      Name.of("ZIP_CODE", false), "zipCode", "CHARACTER VARYING", 100, 0, TypeHandler.forClass(String.class, TypeSource.STATIC_DIALECT_RULE, "D14"));
    static final DirectEntityColumnMetaData ZIP_KODE3_META_DATA = new DirectEntityColumnMetaData(
      Name.of("zip_code", true), "zipKode3", "CHARACTER VARYING", 100, 0, TypeHandler.forClass(String.class, TypeSource.STATIC_DIALECT_RULE, "D14"));
    static final DirectEntityColumnMetaData ZIP_KODE2_META_DATA = new DirectEntityColumnMetaData(
      Name.of("Zip_Code", true), "zipKode2", "CHARACTER VARYING", 100, 0, TypeHandler.forClass(String.class, TypeSource.STATIC_DIALECT_RULE, "D14"));
    static final DirectEntityColumnMetaData NAME_META_DATA = new DirectEntityColumnMetaData(
      Name.of("NAME", false), "name", "CHARACTER VARYING", 20, 0, TypeHandler.forClass(String.class, TypeSource.STATIC_DIALECT_RULE, "D14"));
