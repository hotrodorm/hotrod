...
public class ReceivedDocumentDAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final DirectEntityColumnMetaData RECEIVED = new DirectEntityColumnMetaData(
  ...
  public static class ReceivedDocumentTable extends Table<ReceivedDocument> {
    ...
    public final DateTimeEntityColumn received = new DateTimeEntityColumn(this, MetaData.RECEIVED);
