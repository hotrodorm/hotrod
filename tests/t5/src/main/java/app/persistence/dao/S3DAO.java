// Generated by HotRod 5.1.13-SNAPSHOT on Mar 7, 2026 at 21:04:57
...
public class S3DAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final GeneratedKeysInsertExecutor<Integer> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineKeysResultSetExecutor<Integer>(
        KeyReader.INTEGER_KEY_READER, "NEXT VALUE FOR seq1", MetaData.ID);

    static final DirectEntityColumnMetaData ID = new DirectEntityColumnMetaData(
      "ID", "id", "INTEGER", 32, 0, TypeHandler.forClass(Integer.class, TypeSource.STATIC_DIALECT_RULE, "D9"));
    static final DirectEntityColumnMetaData NAME = new DirectEntityColumnMetaData(
  ...
  public static class S3Table extends TableWithGeneratedKey<S3, Integer> {
    ...
    public final NumericEntityColumn id = new NumericEntityColumn(this, MetaData.ID);
    public final CharEntityColumn name = new CharEntityColumn(this, MetaData.NAME);
