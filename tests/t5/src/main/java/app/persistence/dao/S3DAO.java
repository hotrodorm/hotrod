...
public class S3DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S3Table extends TableWithGeneratedKey<S3, Integer> {
    ...
    private static final GeneratedKeysInsertExecutor<Integer> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequencePreFetchInsertExecutor<Integer>(
        KeyReader.INTEGER_KEY_READER, "SELECT NEXT VALUE FOR seq1", _ID);
    ...
    S3Table() {
      super(null, null, Name.of("S3", false), "Table", null, S3Layout.class, S3.class, __GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    S3Table(final String alias) {
      super(null, null, Name.of("S3", false), "Table", alias, S3Layout.class, S3.class, __GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
