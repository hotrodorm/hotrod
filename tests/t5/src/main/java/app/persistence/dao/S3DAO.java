...
public class S3DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S3Table extends TableWithGeneratedKey<S3, Integer> {
    ...
    private static final NumericEntityColumn _ID = new NumericEntityColumn(
      "id", "id", "int", 10, 0, TypeHandler.forClass(Integer.class, TypeSource.STATIC_DIALECT_RULE, "D10"));
    ...
    private static final GeneratedKeysInsertExecutor<Integer> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineStandardResultSetExecutor<Integer>(
