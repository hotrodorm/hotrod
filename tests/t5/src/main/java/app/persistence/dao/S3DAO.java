...
public class S3DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S3Table extends TableWithGeneratedKey<S3, Integer> {
    ...
    private static final GeneratedKeysInsertExecutor<Integer> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineKeysResultSetExecutor<Integer>(
        KeyReader.INTEGER_KEY_READER, "NEXT VALUE FOR seq1", _ID);
