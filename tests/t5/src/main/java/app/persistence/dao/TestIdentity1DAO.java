// Generated by HotRod 5.1.14-SNAPSHOT on Mar 18, 2026 at 19:13:38
...
public class TestIdentity1DAO implements Serializable, ApplicationContextAware {
  ...
  public static class TestIdentity1Table extends Table<TestIdentity1> {
    ...
    TestIdentity1Table() {
      super(null, null, Name.of("test_identity1", false), "Table", null, TestIdentity1Layout.class, TestIdentity1.class);
      initialize();
    }

    TestIdentity1Table(final String alias) {
      super(null, null, Name.of("test_identity1", false), "Table", alias, TestIdentity1Layout.class, TestIdentity1.class);
      initialize();
    }
