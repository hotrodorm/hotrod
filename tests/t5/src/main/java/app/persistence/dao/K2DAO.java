...
@Component
public class K2DAO implements ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final DirectEntityColumnMetaData ID_META_DATA = new DirectEntityColumnMetaData(
      Name.of("ID", false), "id", "SMALLINT", 16, 0, TypeHandler.forClass(Short.class, TypeSource.STATIC_DIALECT_RULE, "D8"));
    ...
    static final GeneratedKeysInsertExecutor<Short> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysIdentityInlineResultSetInsertExecutor<Short>(
        KeyReader.SHORT_KEY_READER, MetaData.ID_META_DATA.getName().getName());
