...
public class DATALocalDAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final ConvertedColumnMetaData<Integer, Boolean> ACTIVE_META_DATA = new ConvertedColumnMetaData<Integer, Boolean>(
  ...
  public static class DATALocalTable extends Table<DATALocal> {
    ...
    public final BooleanEntityColumn active = new BooleanEntityColumn(this, MetaData.ACTIVE_META_DATA);
