...
public class DATALocalDAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final DirectEntityColumnMetaData NAME_LOCAL_TO_CITY = new DirectEntityColumnMetaData(
      "NAME", "NAMELocalToCity", "CHARACTER VARYING", 20, 0, TypeHandler.forClass(String.class, TypeSource.STATIC_DIALECT_RULE, "D14"));
    static final TypeHandler<Integer, Boolean> TH0 = TypeHandler.forConverter(new IntegerBooleanConverter(), TypeSource.STATIC_DESIGNATED, null);
    static final ConvertedColumnMetaData<Integer, Boolean> ACTIVE = new ConvertedColumnMetaData<Integer, Boolean>(
  ...
  public static class DATALocalTable extends Table<DATALocal> {
    ...
    public final CharEntityColumn NAMELocalToCity = new CharEntityColumn(this, MetaData.NAME_LOCAL_TO_CITY);
    public final BooleanEntityColumn active = new BooleanEntityColumn(this, MetaData.ACTIVE);
