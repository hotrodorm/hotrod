...
public class S1DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S1Table extends TableWithGeneratedKey<S1, Byte> {
    ...
    private static final GeneratedKeysInsertExecutor<Byte> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequencePreFetchInsertExecutor<Byte>(
        KeyReader.BYTE_KEY_READER, "SELECT NEXT VALUE FOR seq1", _ID);
