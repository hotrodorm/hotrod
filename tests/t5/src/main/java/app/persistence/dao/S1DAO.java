...
public class S1DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S1Table extends TableWithGeneratedKey<S1, Byte> {
    ...
    private static final NumericEntityColumn _ID = new NumericEntityColumn(
      "id", "id", "tinyint", 3, 0, TypeHandler.forClass(Byte.class, TypeSource.STATIC_DIALECT_RULE, "D8"));
    ...
    private static final GeneratedKeysInsertExecutor<Byte> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineStandardResultSetExecutor<Byte>(
