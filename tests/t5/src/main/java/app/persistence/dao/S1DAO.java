...
import app.persistence.model.S1;
...
public class S1DAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final GeneratedKeysInsertExecutor<Byte> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineKeysResultSetExecutor<Byte>(
        KeyReader.BYTE_KEY_READER, "NEXT VALUE FOR seq1", MetaData.ID);
  ...
  public static class S1Table extends TableWithGeneratedKey<S1, Byte> {
    ...
    S1Table() {
      super(null, null, Name.of("S1", false), "Table", null, S1Layout.class, S1.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    S1Table(final String alias) {
      super(null, null, Name.of("S1", false), "Table", alias, S1Layout.class, S1.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
