...
public class S2DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S2Table extends TableWithGeneratedKey<S2, Short> {
    ...
    private static final NumericEntityColumn _ID = new NumericEntityColumn(
      "id", "id", "smallint", 5, 0, TypeHandler.forClass(Short.class, TypeSource.STATIC_DIALECT_RULE, "D9"));
    ...
    private static final GeneratedKeysInsertExecutor<Short> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineStandardResultSetExecutor<Short>(
