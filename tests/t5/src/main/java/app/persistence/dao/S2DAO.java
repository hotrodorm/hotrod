...
public class S2DAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final GeneratedKeysInsertExecutor<Short> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineKeysResultSetExecutor<Short>(
        KeyReader.SHORT_KEY_READER, "NEXT VALUE FOR seq1", MetaData.ID);
  ...
  public static class S2Table extends TableWithGeneratedKey<S2, Short> {
    ...
    S2Table() {
      super(null, null, Name.of("S2", false), "Table", null, S2Layout.class, S2.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    S2Table(final String alias) {
      super(null, null, Name.of("S2", false), "Table", alias, S2Layout.class, S2.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
