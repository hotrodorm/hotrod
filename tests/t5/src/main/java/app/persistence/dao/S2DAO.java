...
public class S2DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S2Table extends TableWithGeneratedKey<S2, Short> {
    ...
    private static final GeneratedKeysInsertExecutor<Short> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequencePreFetchInsertExecutor<Short>(
        KeyReader.SHORT_KEY_READER, "SELECT NEXT VALUE FOR seq1", _ID);
