...
public class S4DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S4Table extends TableWithGeneratedKey<S4, Long> {
    ...
    private static final GeneratedKeysInsertExecutor<Long> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineKeysResultSetExecutor<Long>(
        KeyReader.LONG_KEY_READER, "NEXT VALUE FOR seq1", _ID);
