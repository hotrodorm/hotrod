...
public class S4DAO implements Serializable, ApplicationContextAware {
  ...
  public static class S4Table extends TableWithGeneratedKey<S4, Long> {
    ...
    private static final NumericEntityColumn _ID = new NumericEntityColumn(
      "id", "id", "bigint", 19, 0, TypeHandler.forClass(Long.class, TypeSource.STATIC_DIALECT_RULE, "D11"));
    ...
    private static final GeneratedKeysInsertExecutor<Long> __GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineStandardResultSetExecutor<Long>(
