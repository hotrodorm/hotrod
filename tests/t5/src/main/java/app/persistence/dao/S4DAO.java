...
import app.persistence.model.S4;
...
public class S4DAO implements Serializable, ApplicationContextAware {
  ...
  static class MetaData {
    ...
    static final GeneratedKeysInsertExecutor<Long> GENERATED_KEY_READER_EXECUTOR = new GeneratedKeysSequenceInlineKeysResultSetExecutor<Long>(
        KeyReader.LONG_KEY_READER, "NEXT VALUE FOR seq1", MetaData.ID);
  ...
  public static class S4Table extends TableWithGeneratedKey<S4, Long> {
    ...
    S4Table() {
      super(null, null, Name.of("S4", false), "Table", null, S4Layout.class, S4.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    S4Table(final String alias) {
      super(null, null, Name.of("S4", false), "Table", alias, S4Layout.class, S4.class, MetaData.GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
