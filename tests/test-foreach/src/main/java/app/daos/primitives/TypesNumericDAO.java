...
public class TypesNumericDAO implements Serializable, ApplicationContextAware {
  ...
  public CriteriaWherePhase<app.daos.TypesNumericVO> select(final TypesNumericDAO.TypesNumericTable from,
    ...
    return new CriteriaWherePhase<app.daos.TypesNumericVO>(from, this.liveSQLDialect, this.sqlSession,
        predicate, "mappers.typesNumeric.selectByCriteria");
  }
  ...
  public app.daos.TypesNumericVO insert(final app.daos.primitives.AbstractTypesNumericVO vo, final boolean retrieveDefaults) {
    ...
    app.daos.TypesNumericVO mo = new app.daos.TypesNumericVO();
  ...
  public UpdateSetCompletePhase update(final app.daos.primitives.AbstractTypesNumericVO updateValues, final TypesNumericDAO.TypesNumericTable tableOrView, final Predicate predicate) {
    ...
    return new UpdateSetCompletePhase(tableOrView, this.liveSQLDialect, this.sqlSession,
      "mappers.typesNumeric.updateByCriteria", predicate, values);
  }
  ...
  public DeleteWherePhase delete(final TypesNumericDAO.TypesNumericTable from, final Predicate predicate) {
    return new DeleteWherePhase(from, this.liveSQLDialect, this.sqlSession,
      "mappers.typesNumeric.deleteByCriteria", predicate);
  }
  ...
  public enum TypesNumericOrderBy implements OrderBy {
    ...
    INT1("public.types_numeric", "int1", true), //
    INT1$DESC("public.types_numeric", "int1", false), //
    INT2("public.types_numeric", "int2", true), //
    INT2$DESC("public.types_numeric", "int2", false), //
    INT3("public.types_numeric", "int3", true), //
    INT3$DESC("public.types_numeric", "int3", false), //
    INT4("public.types_numeric", "int4", true), //
    INT4$DESC("public.types_numeric", "int4", false), //
    INT5("public.types_numeric", "int5", true), //
    INT5$DESC("public.types_numeric", "int5", false), //
    INT6("public.types_numeric", "int6", true), //
    INT6$DESC("public.types_numeric", "int6", false), //
    DEC1("public.types_numeric", "dec1", true), //
    DEC1$DESC("public.types_numeric", "dec1", false), //
    DEC2("public.types_numeric", "dec2", true), //
    DEC2$DESC("public.types_numeric", "dec2", false), //
    DEC3("public.types_numeric", "dec3", true), //
    DEC3$DESC("public.types_numeric", "dec3", false), //
    DEC4("public.types_numeric", "dec4", true), //
    DEC4$DESC("public.types_numeric", "dec4", false), //
    DEC5("public.types_numeric", "dec5", true), //
    DEC5$DESC("public.types_numeric", "dec5", false), //
    DEC6("public.types_numeric", "dec6", true), //
    DEC6$DESC("public.types_numeric", "dec6", false), //
    DEC7("public.types_numeric", "dec7", true), //
    DEC7$DESC("public.types_numeric", "dec7", false), //
    FLO1("public.types_numeric", "flo1", true), //
    FLO1$DESC("public.types_numeric", "flo1", false), //
    FLO2("public.types_numeric", "flo2", true), //
    FLO2$DESC("public.types_numeric", "flo2", false);
  ...
  public static class TypesNumericTable extends Table {
    ...
    public AllColumns star() {
      return new AllColumns(this, this.int1, this.int2, this.int3, this.int4, this.int5, this.int6, this.dec1, this.dec2, this.dec3, this.dec4, this.dec5, this.dec6, this.dec7, this.flo1, this.flo2);
    }

    // Constructors

    TypesNumericTable() {
      super(null, "public", "types_numeric", "Table", null);
      initialize();
    }

    TypesNumericTable(final String alias) {
      super(null, "public", "types_numeric", "Table", alias);
      initialize();
    }
