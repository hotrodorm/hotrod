...
@Component
public class QueriesBDAO implements Serializable, ApplicationContextAware {
  ...
  */
  ...
  public List<LowBranchVO> findLowBranches() {
    return this.sqlSession.selectList("mappers.queriesBDAO.select_findLowBranches");
  }
