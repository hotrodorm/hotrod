...
public class InvoiceDAO implements Serializable, ApplicationContextAware {
  ...
  public static class InvoiceTable extends Table {
    ...
    public final NumberColumn accountId = new NumberColumn(this, "ACCOUNT_ID", "accountId", "NUMBER", 6, 0, java.lang.Integer.class, null, null);
    ...
    public final DateTimeColumn orderDate = new DateTimeColumn(this, "ORDER_DATE", "orderDate", "DATE", 7, null, java.util.Date.class, null, null);
    public final StringColumn type = new StringColumn(this, "TYPE", "type", "VARCHAR2", 10, null, java.lang.String.class, null, null);
    public final NumberColumn unpaidBalance = new NumberColumn(this, "UNPAID_BALANCE", "unpaidBalance", "NUMBER", 6, 0, java.lang.Integer.class, null, null);
    public final StringColumn status = new StringColumn(this, "STATUS", "status", "VARCHAR2", 10, null, java.lang.String.class, null, null);
