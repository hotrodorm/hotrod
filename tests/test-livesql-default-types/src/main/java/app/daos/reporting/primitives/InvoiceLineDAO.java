...
public class InvoiceLineDAO implements Serializable, ApplicationContextAware {
  ...
  public static class InvoiceLineTable extends Table {
    ...
    public final NumberEntityColumn productId = new NumberEntityColumn(this, "PRODUCT_ID", "productId", "INTEGER", 32, 0, TypeHandler.of(Integer.class, TypeSource.ENTITY_COLUMN));
    public final NumberEntityColumn lineTotal = new NumberEntityColumn(this, "LINE_TOTAL", "lineTotal", "INTEGER", 32, 0, TypeHandler.of(Integer.class, TypeSource.ENTITY_COLUMN));
