...
public class PaymentDAO implements Serializable, ApplicationContextAware {
  ...
  public app.daos.reporting.PaymentVO parseRow(Map<String, Object> m, String prefix, String suffix) {
    ...
    mo.setPaymentDate((java.util.Date) m.get(p + "paymentDate" + s));
  ...
  public static class PaymentTable extends Table {
    ...
    public final DateTimeColumn paymentDate = new DateTimeColumn(this, "PAYMENT_DATE", "paymentDate", "DATE", 7, null, java.util.Date.class, null, null);
    ...
    public final NumberColumn amount = new NumberColumn(this, "AMOUNT", "amount", "NUMBER", 6, 0, java.lang.Integer.class, null, null);
