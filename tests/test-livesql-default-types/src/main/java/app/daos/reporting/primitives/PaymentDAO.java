...
public class PaymentDAO implements Serializable, ApplicationContextAware {
  ...
  public static class PaymentTable extends Table {
    ...
    public final DateTimeColumn paymentDate = new DateTimeColumn(this, "PAYMENT_DATE", "paymentDate", "DATE", 10, 0, java.sql.Date.class, null, null);
    public final NumberColumn invoiceId = new NumberColumn(this, "INVOICE_ID", "invoiceId", "INTEGER", 32, 0, java.lang.Integer.class, null, null);
    public final NumberColumn amount = new NumberColumn(this, "AMOUNT", "amount", "INTEGER", 32, 0, java.lang.Integer.class, null, null);
