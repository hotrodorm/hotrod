...
public class DatesDAO implements Serializable, ApplicationContextAware {
  ...
  public static class DatesTable extends Table {
    ...
    public final DateTimeColumn tim1 = new DateTimeColumn(this, "TIM1", "tim1", "TIME", 8, 0, java.sql.Time.class, null, null);
    public final DateTimeColumn dat1 = new DateTimeColumn(this, "DAT1", "dat1", "DATE", 10, 0, java.sql.Date.class, null, null);
    public final DateTimeColumn ts1 = new DateTimeColumn(this, "TS1", "ts1", "TIMESTAMP", 26, 6, java.sql.Timestamp.class, null, null);
    public final DateTimeColumn ts2 = new DateTimeColumn(this, "TS2", "ts2", "TIMESTAMP", 26, 6, java.sql.Timestamp.class, null, null);
    public final DateTimeColumn ts3 = new DateTimeColumn(this, "TS3", "ts3", "TIMESTAMP", 19, 0, java.sql.Timestamp.class, null, null);
