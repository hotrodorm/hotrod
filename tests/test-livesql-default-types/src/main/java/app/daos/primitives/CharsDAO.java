...
public class CharsDAO implements Serializable, ApplicationContextAware {
  ...
  public app.daos.CharsVO selectByPK(final java.lang.Integer id) {
    if (id == null)
      return null;
    app.daos.CharsVO vo = new app.daos.CharsVO();
    vo.setId(id);
    return this.sqlSession.selectOne("bc.chars.selectByPK", vo);
  }
  ...
  public int update(final app.daos.CharsVO vo) {
    ...
    return this.sqlSession.update("bc.chars.updateByPK", vo);
  }

  // delete by PK

  public int delete(final app.daos.CharsVO vo) {
    if (vo.id == null) return 0;
    return this.sqlSession.delete("bc.chars.deleteByPK", vo);
  }
  ...
  public static class CharsTable extends Table {
    ...
    public AllColumns star() {
      return new AllColumns(this, this.id, this.cha1, this.cha2, this.cha3);
    }
