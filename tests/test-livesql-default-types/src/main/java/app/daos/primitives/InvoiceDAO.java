...
public class InvoiceDAO implements Serializable, ApplicationContextAware {
  ...
  public static InvoiceEntity<app.daos.InvoiceVO> newEntity() {
    return new InvoiceEntity<app.daos.InvoiceVO>();
  }

  public static InvoiceEntity<app.daos.InvoiceVO> newEntity(final String alias) {
    return new InvoiceEntity<app.daos.InvoiceVO>(alias);
  }

  public static class InvoiceEntity<T> extends Entity<T> {
    ...
    InvoiceEntity(final String alias) {
      super(null, null, "INVOICE", "Table", alias);
      initialize();
    }
