...
public class AccountDAO implements Serializable, ApplicationContextAware {
  ...
  public UpdateSetCompletePhase update(final app.daos.primitives.AbstractAccountVO updateValues, final AccountDAO.AccountTable tableOrView, final GeneralBooleanExpression predicate) {
  ...
  public DeleteWherePhase delete(final AccountDAO.AccountTable from, final GeneralBooleanExpression predicate) {
  ...
  public static class AccountTable extends Table {
    ...
    public final NumberEntityColumn parentId = new NumberEntityColumn(this, "PARENT_ID", "parentId", "INTEGER", 32, 0, org.hotrod.runtime.livesql.queries.typesolver.TypeHandler.of(java.lang.Integer.class, TypeSource.ENTITY_COLUMN));
