...
public class TypesCharDAO implements Serializable, ApplicationContextAware {
  ...
  public CriteriaWherePhase<test.persistence.TypesCharVO> selectByCriteria(final TypesCharDAO.TypesCharTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<test.persistence.TypesCharVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "test.persistence.primitives.typesChar.selectByCriteria");
  }
