...
public class TypesNumericDAO implements Serializable, ApplicationContextAware {
  ...
  public CriteriaWherePhase<test.persistence.TypesNumericVO> selectByCriteria(final TypesNumericDAO.TypesNumericTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<test.persistence.TypesNumericVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "test.persistence.primitives.typesNumeric.selectByCriteria");
  }
  ...
  public static class TypesNumericTable extends Table {
    ...
    private void initialize() {
      ...
      this.int4 = new ObjectColumn(this, "int4", "int4");
