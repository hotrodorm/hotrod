...
public class EventDAO implements Serializable, ApplicationContextAware {
  ...
  public test.persistence.EventVO selectByPK(final java.lang.Long id) {
    if (id == null)
      return null;
    test.persistence.EventVO vo = new test.persistence.EventVO();
    vo.setId(id);
    return this.sqlSession.selectOne("test.persistence.primitives.event.selectByPK", vo);
  }
  ...
  public CriteriaWherePhase<test.persistence.EventVO> selectByCriteria(final EventDAO.EventTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<test.persistence.EventVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "test.persistence.primitives.event.selectByCriteria");
  }
  ...
  public int update(final test.persistence.EventVO vo) {
    if (vo.id == null) return 0;
    return this.sqlSession.update("test.persistence.primitives.event.updateByPK", vo);
  }

  // delete by PK

  public int delete(final test.persistence.EventVO vo) {
    if (vo.id == null) return 0;
    return this.sqlSession.delete("test.persistence.primitives.event.deleteByPK", vo);
  }
