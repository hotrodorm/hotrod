...
public class TypesOtherDAO implements Serializable, ApplicationContextAware {
  ...
  public CriteriaWherePhase<test.persistence.TypesOtherVO> selectByCriteria(final TypesOtherDAO.TypesOtherTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<test.persistence.TypesOtherVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "test.persistence.primitives.typesOther.selectByCriteria");
  }
