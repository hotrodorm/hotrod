...
public class EmployeeDAO implements Serializable, ApplicationContextAware {
  ...
  public static class EmployeeTable extends TableWithGeneratedKey<Employee, Integer> {
    ...
    private static final NumericEntityColumnMetaData _BRANCH_ID = new NumericEntityColumnMetaData(
    ...
    public final NumericEntityColumn branchId = new NumericEntityColumn(this, _BRANCH_ID);
    ...
    EmployeeTable() {
      super(null, null, Name.of("EMPLOYEE", false), "Table", null, EmployeeLayout.class, Employee.class, __GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }

    EmployeeTable(final String alias) {
      super(null, null, Name.of("EMPLOYEE", false), "Table", alias, EmployeeLayout.class, Employee.class, __GENERATED_KEY_READER_EXECUTOR);
      initialize();
    }
