...
public class EmployeeDAO implements Serializable, ApplicationContextAware {
  ...
  public app.daos.EmployeeVO parseRow(Map<String, Object> m, String prefix, String suffix) {
    ...
    mo.setFirstName((java.lang.String) m.get(p + "firstName" + s));
    mo.setLastName((java.lang.String) m.get(p + "lastName" + s));
  ...
  public app.daos.EmployeeVO insert(final app.daos.primitives.Employee vo) {
    ...
    mo.setId(vo.getId());
    mo.setFirstName(vo.getFirstName());
    mo.setLastName(vo.getLastName());
  ...
  public UpdateSetCompletePhase update(final app.daos.primitives.Employee updateValues, final EmployeeDAO.EmployeeTable tableOrView, final Predicate predicate) {
    ...
    if (updateValues.getFirstName() != null) values.put("first_name", updateValues.getFirstName());
    if (updateValues.getLastName() != null) values.put("last_name", updateValues.getLastName());
  ...
  public enum EmployeeOrderBy implements OrderBy {
    ...
    FIRST_NAME("public.employee", "first_name", true), //
    FIRST_NAME$DESC("public.employee", "first_name", false), //
    FIRST_NAME$CASEINSENSITIVE("public.employee", "lower(first_name)", true), //
    FIRST_NAME$CASEINSENSITIVE_STABLE_FORWARD("public.employee", "lower(first_name), first_name", true), //
    FIRST_NAME$CASEINSENSITIVE_STABLE_REVERSE("public.employee", "lower(first_name), first_name", false), //
    FIRST_NAME$DESC_CASEINSENSITIVE("public.employee", "lower(first_name)", false), //
    FIRST_NAME$DESC_CASEINSENSITIVE_STABLE_FORWARD("public.employee", "lower(first_name), first_name", false), //
    FIRST_NAME$DESC_CASEINSENSITIVE_STABLE_REVERSE("public.employee", "lower(first_name), first_name", true), //
    LAST_NAME("public.employee", "last_name", true), //
    LAST_NAME$DESC("public.employee", "last_name", false), //
    LAST_NAME$CASEINSENSITIVE("public.employee", "lower(last_name)", true), //
    LAST_NAME$CASEINSENSITIVE_STABLE_FORWARD("public.employee", "lower(last_name), last_name", true), //
    LAST_NAME$CASEINSENSITIVE_STABLE_REVERSE("public.employee", "lower(last_name), last_name", false), //
    LAST_NAME$DESC_CASEINSENSITIVE("public.employee", "lower(last_name)", false), //
    LAST_NAME$DESC_CASEINSENSITIVE_STABLE_FORWARD("public.employee", "lower(last_name), last_name", false), //
    LAST_NAME$DESC_CASEINSENSITIVE_STABLE_REVERSE("public.employee", "lower(last_name), last_name", true), //
  ...
  public static class EmployeeTable extends Table {
    ...
    public StringColumn firstName;
    public StringColumn lastName;
    public NumberColumn branchId;

    // Getters

    public AllColumns star() {
      return new AllColumns(this.id, this.firstName, this.lastName, this.branchId);
    }
    ...
    private void initialize() {
      ...
      this.firstName = new StringColumn(this, "FIRST_NAME", "firstName", "CHARACTER VARYING", 20, 0);
      super.columns.add(this.firstName);
      this.lastName = new StringColumn(this, "LAST_NAME", "lastName", "CHARACTER VARYING", 20, 0);
