...
@Component
public class WebDAO implements Serializable, ApplicationContextAware {
  ...
  */
  ...
  public List<InvoiceWithLinesVO> searchInvoices() {
    return this.sqlSession.selectList("mappers.webDAO.select_searchInvoices");
  }
