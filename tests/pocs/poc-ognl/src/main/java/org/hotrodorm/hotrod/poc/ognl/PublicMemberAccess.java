...
public class PublicMemberAccess implements MemberAccess {
  ...
  public Object setup(final @SuppressWarnings("rawtypes") Map context, final Object target, final Member member,
      final String propertyName) {
    System.out.println(
        "[setup] context=" + context + " target=" + target + " member=" + member + " property=" + propertyName);
    return null;
  }
  ...
  public void restore(final @SuppressWarnings("rawtypes") Map context, final Object target, final Member member,
    ...
    System.out.println(
        "[restore] context=" + context + " target=" + target + " member=" + member + " property=" + propertyName);
  }
