...
public class DomainLogPrototype implements Serializable {
  ...
  public final java.sql.Timestamp getRecordedAt() {
    return this.recordedAt;
  }

  public final void setRecordedAt(final java.sql.Timestamp recordedAt) {
