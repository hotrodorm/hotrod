...
public class IndexOrOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "INDEX OR";

  public IndexOrOperator(final T id, final String specificName, final SourceSet sourceSet,
