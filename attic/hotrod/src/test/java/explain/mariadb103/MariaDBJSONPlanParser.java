...
public class MariaDBJSONPlanParser {
  ...
  public static MariaDBOperator parse(final Connection conn, final String jsonPlan) {
    ...
    System.out.println("b.getTable()=" + b.getTable());
  ...
  private static MariaDBOperator getOperator(final String prefix, final QueryBlock b) {
    ...
    if (b.getTable() != null) {
      ...
      // MariaDBOperator so = getOperator("(" + (correlated ? "correlated " :
      // "") + "subquery) ", sb);
      ...
      MariaDBOperator op = new MariaDBOperator(id, type, includesHeapFetch, cost, examinedRows, producedBytes,
          producedRows, rowsSource, rowsSourceAlias, indexName, accessPredicates, filterPredicates, innerOperators,
          extraProperties);
      ...
      //
      // MariaDBOperator op = getNestedLoopOperator(prefix, id, b.getCostInfo(),
      // b.getNestedLoopElements());
      //
      // for (OptimizedAwaySubquery oa : b.getOptimizedAwaySubqueries()) {
      // QueryBlock oab = oa.getQueryBlock();
      // if (oab != null) {
  ...
  // private static MariaDBOperator getNestedLoopOperator(final String prefix,
  // final Integer id, final CostInfo costInfo,
  ...
  // }
  //
  // private static MariaDBOperator getTableOperator(final String prefix, final
  // Integer id, final Table t) {
  // String type = (prefix != null ? prefix : "") + "NL." + t.getAccessType();
  // boolean includesHeapFetch = false; // TODO ?
  // Double cost = t.getCostInfo() == null ? null :
  // t.getCostInfo().computeCost();
  ...
  // if (t.getKey() != null) {
  // accessPredicates.add("index " + t.getKey() + " (" +
  // ListWriter.render(t.getUsedKeyParts(), ", ") + ")");
  // }
  //
  // List<String> filterPredicates = new ArrayList<String>();
  ...
  // }
  //
  // LinkedHashMap<String, String> extraProperties = new LinkedHashMap<String,
  // String>();
  //
  // MariaDBOperator xop = new MariaDBOperator(id, type, includesHeapFetch,
  // cost, examinedRows, producedBytes, producedRows,
  // rowsSource, rowsSourceAlias, indexName, accessPredicates, filterPredicates,
  // innerOperators, extraProperties);
  // return xop;
  // }
  //
  ...
  // List<String> filterPredicates = new ArrayList<String>();
  // List<MariaDBOperator> innerOperators = new ArrayList<MariaDBOperator>();
  // LinkedHashMap<String, String> xExtraProperties = new LinkedHashMap<String,
  // String>();
  //
  // MariaDBOperator op = new MariaDBOperator(id, type, includesHeapFetch, cost,
  // examinedRows, producedBytes, producedRows,
  // rowsSource, rowsSourceAlias, indexName, accessPredicates, filterPredicates,
  // innerOperators, xExtraProperties);
  // return op;
  // }
  //
  ...
  // }
  //
  // private static void compileExistingIds(final MariaDBOperator op, final
  ...
  // }
  //
  // private static void addIds(final MariaDBOperator op, final Set<Integer>
  // existing) {
  // if (op.getId() == null) {
  // op.setId(nextId);
  // nextId = nextId + 1;
