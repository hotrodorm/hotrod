...
any of the world-class [supported databases](./hotrod-project/docs/config/supported-databases.md).

See [What's New](./hotrod-project/docs/whats-new.md) in HotRod 5 and the [Version History](./hotrod-project/docs/version-history.md). For documentation on the previous versions see [HotRod 4 Documentation](./hotrod-project/docs/docs-4/README.md) and [HotRod 3 Documentation](./hotrod-project/docs/docs-3/README.md).

## LiveSQL -- At a Glance

LiveSQL runs queries built directly in your Java application.
...
For more details see [HotRod 5 Documentation](./hotrod-project/docs/docs-5/README.md).
