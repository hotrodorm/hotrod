...
select nextval('seq_house')
  ...
  */
  ...
  public Cursor<ExpensiveProductVO> findExpensiveProducts(final Integer minPrice, final String when) {
    ParamFindExpensiveProducts param0 = new ParamFindExpensiveProducts();
    param0.minPrice = minPrice;
    param0.when = when;
    return     new MyBatisCursor<ExpensiveProductVO>(this.sqlSession.selectCursor("app5.persistence.primitives.myQueriesDAO.select_findExpensiveProducts", param0));
  }
