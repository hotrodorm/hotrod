...
public class NumberColumn extends NumberExpression implements ReferenceableExpression {
  ...
  public NumberColumn(final TableOrView objectIntance, final String name) {
    super(PRECEDENCE);
