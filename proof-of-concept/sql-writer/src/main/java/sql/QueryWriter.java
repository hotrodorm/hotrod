...
public class QueryWriter {
  ...
  public QueryWriter(final boolean multiLine) {
    ...
    this.leftMargin = "";
    log("::constructor #1: this.multiLine=" + this.multiLine);
  }

  public QueryWriter(final boolean multiLine, final int leftIndent, final boolean marginFirstLine) {
    this.multiLine = multiLine;
    this.level = 0;
    ...
    log("::constructor #2: this.multiLine=" + this.multiLine);
  }
  ...
  public void exitLevel() {
    ...
    this.level--;
    if (this.multiLine && !marker.inLine) {
      this.newLine();
      this.indent();
    }
