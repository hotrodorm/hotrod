...
public class ResultOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "SORT";

  public ResultOperator(final T id, final String specificName, final SourceSet sourceSet,
