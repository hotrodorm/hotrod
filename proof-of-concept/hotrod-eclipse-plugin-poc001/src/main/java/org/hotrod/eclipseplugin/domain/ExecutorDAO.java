...
public class ExecutorDAO extends DAO {

  private String name;
  private String content;

  public ExecutorDAO(final NameContent nc, final int lineNumber) {
    super(lineNumber);
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ExecutorDAO other = (ExecutorDAO) obj;
    if (name == null) {
      if (other.name != null)
        return false;
  ...
  public boolean sameID(final ConfigItem fresh) {
    try {
      ExecutorDAO f = (ExecutorDAO) fresh;
