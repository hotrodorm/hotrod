...
import com.company.cli.maven_test.daos.TypesCharVO;
...
public class TypesCharDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.cli.maven_test.daos.TypesCharVO> selectByExample(final com.company.cli.maven_test.daos.TypesCharVO example, final TypesCharOrderBy... orderBies)
      {
    DaoWithOrder<com.company.cli.maven_test.daos.TypesCharVO, TypesCharOrderBy> dwo = //
        new DaoWithOrder<com.company.cli.maven_test.daos.TypesCharVO, TypesCharOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.cli.maven_test.daos.primitives.typesChar.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.cli.maven_test.daos.TypesCharVO> selectByCriteria(final TypesCharDAO.TypesCharTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.cli.maven_test.daos.TypesCharVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.cli.maven_test.daos.primitives.typesChar.selectByCriteria");
  }

  // insert

  public int insert(final com.company.cli.maven_test.daos.TypesCharVO vo) {
    String id = "com.company.cli.maven_test.daos.primitives.typesChar.insert";
  ...
  public int updateByExample(final com.company.cli.maven_test.daos.TypesCharVO example, final com.company.cli.maven_test.daos.TypesCharVO updateValues) {
    UpdateByExampleDao<com.company.cli.maven_test.daos.TypesCharVO> fvd = //
      new UpdateByExampleDao<com.company.cli.maven_test.daos.TypesCharVO>(example, updateValues);
    return this.sqlSession.update("com.company.cli.maven_test.daos.primitives.typesChar.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.cli.maven_test.daos.TypesCharVO example) {
    return this.sqlSession.delete("com.company.cli.maven_test.daos.primitives.typesChar.deleteByExample", example);
  }
