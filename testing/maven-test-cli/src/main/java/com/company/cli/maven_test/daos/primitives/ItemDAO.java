...
import com.company.cli.maven_test.daos.ItemVO;
...
public class ItemDAO implements Serializable, ApplicationContextAware {
  ...
  public List<com.company.cli.maven_test.daos.ItemVO> selectByExample(final com.company.cli.maven_test.daos.ItemVO example, final ItemOrderBy... orderBies)
      {
    DaoWithOrder<com.company.cli.maven_test.daos.ItemVO, ItemOrderBy> dwo = //
        new DaoWithOrder<com.company.cli.maven_test.daos.ItemVO, ItemOrderBy>(example, orderBies);
    return this.sqlSession.selectList("com.company.cli.maven_test.daos.primitives.item.selectByExample", dwo);
  }

  // select by criteria

  public CriteriaWherePhase<com.company.cli.maven_test.daos.ItemVO> selectByCriteria(final ItemDAO.ItemTable from,
      final Predicate predicate) {
    return new CriteriaWherePhase<com.company.cli.maven_test.daos.ItemVO>(from, this.sqlDialect, this.sqlSession,
        predicate, "com.company.cli.maven_test.daos.primitives.item.selectByCriteria");
  }

  // insert

  public int insert(final com.company.cli.maven_test.daos.ItemVO vo) {
    String id = "com.company.cli.maven_test.daos.primitives.item.insert";
  ...
  public int updateByExample(final com.company.cli.maven_test.daos.ItemVO example, final com.company.cli.maven_test.daos.ItemVO updateValues) {
    UpdateByExampleDao<com.company.cli.maven_test.daos.ItemVO> fvd = //
      new UpdateByExampleDao<com.company.cli.maven_test.daos.ItemVO>(example, updateValues);
    return this.sqlSession.update("com.company.cli.maven_test.daos.primitives.item.updateByExample", fvd);
  }

  // delete by example

  public int deleteByExample(final com.company.cli.maven_test.daos.ItemVO example) {
    return this.sqlSession.delete("com.company.cli.maven_test.daos.primitives.item.deleteByExample", example);
  }
