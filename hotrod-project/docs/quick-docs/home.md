...
HotRod follows the *Database First* approach. No need to create Java classes with annotations by hand. Tell HotRod where the database is and it takes care of producing all classes along with a comprehensible persistence layer in seconds.
