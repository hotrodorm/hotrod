...
When a LiveSQL statement is executed it's first assembled into native SQL statement. Then this native 
SQL statement is sent to the database engine for its execution.
