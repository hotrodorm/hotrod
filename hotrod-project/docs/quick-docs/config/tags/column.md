...
| `jdbc-type` | Sets the JDBC type for inserting or updating nulls in the database. This is a requirement of the JDBC spec where each nulls needs to be specifying when applied as a query parameter | Default database JDBC type |
