...
The HyperSQL HSQLDB Dialect defines Static Dialect Rules and Runtime Dialect Rules to decide the app types for the most common database column types when data is retrieved from the database using SELECT queries.
...
| `SMALLINT` | `java.lang.Short`:small_orange_diamond:D8 |
| `INTEGER` | `java.lang.Integer`:small_orange_diamond:D9 |
| `BIGINT` | `java.lang.Long`:small_orange_diamond:D10 |
| `REAL`,<br/>`FLOAT`,<br/>`DOUBLE` | `java.lang.Double`:small_orange_diamond:D11 |
| `CHAR(n)`,<br/>`CHARACTER(n)` | `java.lang.String`:small_orange_diamond:D12 |
| `VARCHAR(n)`,<br/>`CHARACTER VARYING(n)`,<br/>`CHAR VARYING(n)`,<br/>`LONGVARCHAR(n)`:small_orange_diamond:D13 |`java.lang.String` |
| `CLOB(n)` | `java.lang.String`:small_orange_diamond:D14 |
| `DATE` | `java.time.LocalDate`:small_orange_diamond:D15 |
| `TIME(n)` | `java.time.LocalTime`:small_orange_diamond:D16 |
| `TIME(n) WITH TIME ZONE` | `java.time.OffsetTime`:small_orange_diamond:D17 |
| `TIMESTAMP(n)` | `java.time.LocalDateTime`:small_orange_diamond:D18 |
| `TIMESTAMP(n) WITH TIME ZONE` | `java.time.OffsetDateTime`:small_orange_diamond:D19 |
| `INTERVAL <qualifier>` | No dialect rule |
| `BOOLEAN` | `java.lang.Boolean`:small_orange_diamond:D20 |
| `BINARY(n)`,<br/>`VARBINARY(n)`,<br/>`BLOB(n)` | `byte[]`:small_orange_diamond:D21 |
...
| `SMALLINT` | `java.lang.Short`:small_orange_diamond:RD8 |
| `INTEGER` | `java.lang.Integer`:small_orange_diamond:RD9 |
| `BIGINT` | `java.lang.Long`:small_orange_diamond:RD10 |
| `REAL`,<br/>`FLOAT`,<br/>`DOUBLE` | `java.lang.Double`:small_orange_diamond:RD11 |
| `CHAR(n)`,<br/>`CHARACTER(n)` | `java.lang.String`:small_orange_diamond:RD12 |
| `VARCHAR(n)`,<br/>`CHARACTER VARYING(n)`,<br/>`CHAR VARYING(n)`,<br/>`LONGVARCHAR(n)`:small_orange_diamond:RD13 |`java.lang.String` |
| `CLOB(n)` | `java.lang.String`:small_orange_diamond:RD14 |
| `DATE` | `java.time.LocalDate`:small_orange_diamond:RD15 |
| `TIME(n)` | `java.time.LocalTime`:small_orange_diamond:RD16 |
| `TIME(n) WITH TIME ZONE` | `java.time.OffsetTime`:small_orange_diamond:RD17 |
| `TIMESTAMP(n)` | `java.time.LocalDateTime`:small_orange_diamond:RD18 |
| `TIMESTAMP(n) WITH TIME ZONE` | `java.time.OffsetDateTime`:small_orange_diamond:RD19 |
| `INTERVAL <qualifier>` | No dialect rule |
| `BOOLEAN` | `java.lang.Boolean`:small_orange_diamond:RD20 |
| `BINARY(n)`,<br/>`VARBINARY(n)`,<br/>`BLOB(n)` | `byte[]`:small_orange_diamond:RD21 |
| `ARRAY` | No dialect rule |
| `BIT(n)`,<br/>`BIT VARYING(n)` | No dialect rule |
