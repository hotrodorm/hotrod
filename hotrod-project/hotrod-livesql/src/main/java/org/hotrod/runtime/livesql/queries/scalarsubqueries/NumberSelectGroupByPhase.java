...
public class NumberSelectGroupByPhase extends NumberSelectExpression {

  // Constructor

  NumberSelectGroupByPhase(final AbstractSelectObject<Row> select, final ComparableExpression... expressions) {
    super(select);
  ...
  public NumberSelectHavingPhase having(final GeneralBooleanExpression predicate) {
    return new NumberSelectHavingPhase(this.select, predicate);
  }
