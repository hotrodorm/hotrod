...
public abstract class BooleanFunction extends Predicate {
  ...
  protected BooleanFunction(final String name, final Expression... parameters) {
  ...
  protected BooleanFunction(final String name, final String qualifier, final Expression... parameters) {
    super(Expression.PRECEDENCE_FUNCTION);
    if (SUtil.isEmpty(name)) {
      throw new InvalidFunctionException("The function name cannot be empty");
    }
  ...
  protected BooleanFunction(final String name, final boolean includeParenthesis, final Expression... parameters) {
    super(Expression.PRECEDENCE_FUNCTION);
    if (SUtil.isEmpty(name)) {
      throw new InvalidFunctionException("The function name cannot be empty");
    }
  ...
  protected BooleanFunction(final String name, final String qualifier, final boolean includeParenthesis,
