...
public class DateTimeSelectHavingPhase extends DateTimeSelectExpression {

  // Constructor

  DateTimeSelectHavingPhase(final AbstractSelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
    if (predicate != null) {
