...
public class StringSelectColumnsPhase extends StringSelectExpression {
  ...
  public StringSelectColumnsPhase(final LiveSQLDialect sqlDialect, final SqlSession sqlSession,
      final LiveSQLMapper liveSQLMapper, final boolean distinct, final StringExpression expression) {
