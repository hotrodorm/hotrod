...
public class ObjectSelectColumnsPhase extends ObjectSelectExpression {
  ...
  public ObjectSelectFromPhase from(final TableExpression tableViewOrSubquery) {
    return new ObjectSelectFromPhase(this.select, tableViewOrSubquery);
  }
