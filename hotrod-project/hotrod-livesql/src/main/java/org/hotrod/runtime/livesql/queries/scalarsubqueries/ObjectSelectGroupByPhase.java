...
public class ObjectSelectGroupByPhase extends ObjectSelectExpression {
  ...
  ObjectSelectGroupByPhase(final AbstractSelectObject<Row> select, final ComparableExpression... expressions) {
    super(select);
  ...
  public ObjectSelectHavingPhase having(final GeneralBooleanExpression predicate) {
