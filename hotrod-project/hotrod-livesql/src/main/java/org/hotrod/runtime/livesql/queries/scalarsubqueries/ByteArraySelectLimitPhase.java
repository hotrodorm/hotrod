...
public class ByteArraySelectLimitPhase extends ByteArraySelectExpression {

  // Constructor

  ByteArraySelectLimitPhase(final AbstractSelectObject<Row> select, final int limit) {
    super(select);
