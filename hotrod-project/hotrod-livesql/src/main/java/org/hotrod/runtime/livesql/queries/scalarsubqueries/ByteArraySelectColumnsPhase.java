...
public class ByteArraySelectColumnsPhase extends ByteArraySelectExpression {
  ...
  public ByteArraySelectColumnsPhase(final LiveSQLDialect sqlDialect, final SqlSession sqlSession,
      final LiveSQLMapper liveSQLMapper, final boolean distinct, final ByteArrayExpression expression) {
  ...
  public ByteArraySelectFromPhase from(final TableExpression tableViewOrSubquery) {
    return new ByteArraySelectFromPhase(this.select, tableViewOrSubquery);
  }
