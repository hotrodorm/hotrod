...
public abstract class ObjectFunction extends ObjectExpression {
  ...
  protected ObjectFunction(final String name, final String qualifier, final Expression... parameters) {
    super(Expression.PRECEDENCE_FUNCTION);
    if (SUtil.isEmpty(name)) {
      throw new InvalidFunctionException("The function name cannot be empty");
    }
  ...
  protected ObjectFunction(final String name, final boolean includeParenthesis, final Expression... parameters) {
    super(Expression.PRECEDENCE_FUNCTION);
    if (SUtil.isEmpty(name)) {
      throw new InvalidFunctionException("The function name cannot be empty");
    }
  ...
  protected ObjectFunction(final String name, final String qualifier, final boolean includeParenthesis,
