...
public class NumberSelectWherePhase extends NumberSelectExpression {

  // Constructors

  NumberSelectWherePhase(final AbstractSelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
