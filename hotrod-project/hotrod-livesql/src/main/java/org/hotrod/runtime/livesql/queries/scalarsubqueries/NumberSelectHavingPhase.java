...
public class NumberSelectHavingPhase extends NumberSelectExpression {

  // Constructor

  NumberSelectHavingPhase(final AbstractSelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
    if (predicate != null) {
