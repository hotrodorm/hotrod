...
public abstract class ByteArrayFunction extends ByteArrayExpression {
  ...
  protected ByteArrayFunction(final String name, final String qualifier, final Expression... parameters) {
    super(Expression.PRECEDENCE_FUNCTION);
    if (SUtil.isEmpty(name)) {
      throw new InvalidFunctionException("The function name cannot be empty");
    }
  ...
  protected ByteArrayFunction(final String name, final boolean includeParenthesis, final Expression... parameters) {
    super(Expression.PRECEDENCE_FUNCTION);
    if (SUtil.isEmpty(name)) {
      throw new InvalidFunctionException("The function name cannot be empty");
    }
  ...
  protected ByteArrayFunction(final String name, final String qualifier, final boolean includeParenthesis,
