...
public class BinarySelectOrderByPhase extends BinarySelectExpression {

  // Constructor

  BinarySelectOrderByPhase(final UnarySelectObject<Row> select, final OrderingTerm... orderingTerms) {
    super(select);
