...
public abstract class DateTimeFunction extends DateTimeSyntaxExpression {

  private FunctionTemplate template;

  protected DateTimeFunction(final String pattern, final ComparableExpression... parameters) {
