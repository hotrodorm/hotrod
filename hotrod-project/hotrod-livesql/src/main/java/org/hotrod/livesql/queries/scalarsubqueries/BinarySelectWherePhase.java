...
public class BinarySelectWherePhase extends BinarySelectExpression {

  // Constructors

  BinarySelectWherePhase(final UnarySelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
