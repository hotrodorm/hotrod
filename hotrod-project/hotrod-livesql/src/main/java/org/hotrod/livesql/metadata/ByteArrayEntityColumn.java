...
public class ByteArrayEntityColumn extends GeneralByteArrayExpression implements EntityColumn {
  ...
  public ByteArrayEntityColumn(final TableOrView objectInstance, final String name, final String property,
