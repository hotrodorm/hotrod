...
public class SelectTuplesFrom4Phase<A, B, C, D> {
  ...
  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> join(T0 t, final Predicate on) {
    this.metadata.join(new InnerJoin(t, on));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> join(T0 t, final EntityColumn... using) {
    this.metadata.join(new InnerJoin(t, using));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> leftJoin(T0 t,
      final Predicate on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> leftJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new LeftOuterJoin(t, using));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> rightJoin(T0 t,
      final Predicate on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> rightJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new RightOuterJoin(t, using));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> fullJoin(T0 t,
      final Predicate on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> fullJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new FullOuterJoin(t, using));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> crossJoin(T0 t) {
    this.metadata.join(new CrossJoin(t));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> naturalJoin(T0 t) {
    this.metadata.join(new NaturalInnerJoin(t));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> naturalLeftJoin(T0 t) {
    this.metadata.join(new NaturalLeftOuterJoin(t));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> naturalRightJoin(T0 t) {
    this.metadata.join(new NaturalRightOuterJoin(t));
    return new SelectTuplesFrom5Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom5Phase<A, B, C, D, E> naturalFullJoin(T0 t) {
  ...
  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiJoin(T0 t, final Predicate on) {
    this.metadata.join(new InnerJoin(t, on), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new InnerJoin(t, using), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiLeftJoin(T0 t, final Predicate on) {
    this.metadata.join(new LeftOuterJoin(t, on), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiLeftJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new LeftOuterJoin(t, using), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiRightJoin(T0 t, final Predicate on) {
    this.metadata.join(new RightOuterJoin(t, on), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiRightJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new RightOuterJoin(t, using), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiFullJoin(T0 t, final Predicate on) {
    this.metadata.join(new FullOuterJoin(t, on), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiFullJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new FullOuterJoin(t, using), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiCrossJoin(T0 t) {
    this.metadata.join(new CrossJoin(t), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiNaturalJoin(T0 t) {
    this.metadata.join(new NaturalInnerJoin(t), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiNaturalLeftJoin(T0 t) {
    this.metadata.join(new NaturalLeftOuterJoin(t), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiNaturalRightJoin(T0 t) {
    this.metadata.join(new NaturalRightOuterJoin(t), false);
    return new SelectTuplesFrom4Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<E>, E> SelectTuplesFrom4Phase<A, B, C, D> semiNaturalFullJoin(T0 t) {
  ...
  public List<Tuple4<A, B, C, D>> execute(LiveSQLLogging loggingAdapter) {
    CombinedSelectObject<Tuple4<A, B, C, D>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.execute(this.metadata.getContext(), loggingAdapter);
  }

  public Cursor<Tuple4<A, B, C, D>> executeCursor(LiveSQLLogging loggingAdapter) throws SQLException {
    CombinedSelectObject<Tuple4<A, B, C, D>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), loggingAdapter);
  }

  public Cursor<Tuple4<A, B, C, D>> executeCursor(LiveSQLLogging loggingAdapter, int fetchSize) throws SQLException {
    CombinedSelectObject<Tuple4<A, B, C, D>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), loggingAdapter, fetchSize);
  }

  public Tuple4<A, B, C, D> executeOne(LiveSQLLogging loggingAdapter) throws SQLException {
    CombinedSelectObject<Tuple4<A, B, C, D>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
