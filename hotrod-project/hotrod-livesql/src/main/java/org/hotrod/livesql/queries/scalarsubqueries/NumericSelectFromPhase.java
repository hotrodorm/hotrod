...
public class NumericSelectFromPhase extends NumericSelectExpression {
  ...
  public NumericSelectFromPhase join(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
  ...
  public NumericSelectFromPhase leftJoin(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
  ...
  public NumericSelectFromPhase rightJoin(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
  ...
  public NumericSelectFromPhase fullJoin(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
  ...
  public NumericSelectWherePhase where(final GeneralBooleanExpression predicate) {
