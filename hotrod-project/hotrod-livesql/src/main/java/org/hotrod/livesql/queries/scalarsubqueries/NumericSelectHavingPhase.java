...
public class NumericSelectHavingPhase extends NumericSelectExpression {

  // Constructor

  NumericSelectHavingPhase(final UnarySelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
    if (predicate != null) {
