...
public class StringSelectHavingPhase extends StringSelectExpression {

  // Constructor

  StringSelectHavingPhase(final AbstractSelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
    if (predicate != null) {
