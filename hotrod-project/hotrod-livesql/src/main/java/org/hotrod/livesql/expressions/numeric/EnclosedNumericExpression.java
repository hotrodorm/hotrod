...
public class EnclosedNumericExpression extends NumericExpression {

  // Properties

  private GeneralNumericExpression expr;

  // Constructor

  public EnclosedNumericExpression(final GeneralNumericExpression expr) {
