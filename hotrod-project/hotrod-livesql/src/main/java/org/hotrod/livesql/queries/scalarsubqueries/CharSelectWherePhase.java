...
public class CharSelectWherePhase extends CharSelectExpression {

  // Constructors

  CharSelectWherePhase(final UnarySelectObject<Row> select, final BooleanExpression predicate) {
    super(select);
