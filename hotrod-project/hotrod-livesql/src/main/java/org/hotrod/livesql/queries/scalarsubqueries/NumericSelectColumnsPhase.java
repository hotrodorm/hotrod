...
public class NumericSelectColumnsPhase extends NumericSelectExpression {
  ...
  public NumericSelectFromPhase from(final TableExpression tableViewOrSubquery) {
    return new NumericSelectFromPhase(this.select, tableViewOrSubquery);
  }
