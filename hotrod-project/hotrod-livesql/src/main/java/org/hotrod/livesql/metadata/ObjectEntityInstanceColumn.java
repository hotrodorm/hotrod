...
public class ObjectEntityInstanceColumn extends ObjectExpression implements EntityInstanceColumn {

  private static final Logger log = Logger.getLogger(ObjectEntityInstanceColumn.class.getName());

  // Properties

  private TableOrView<?> objectInstance;
  private ObjectEntityColumn entityColumn;

  // Constructor

  public ObjectEntityInstanceColumn(final TableOrView<?> objectInstance, final ObjectEntityColumn entityColumn) {
