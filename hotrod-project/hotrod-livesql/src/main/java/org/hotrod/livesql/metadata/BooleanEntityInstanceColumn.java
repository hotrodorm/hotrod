...
public class BooleanEntityInstanceColumn extends Predicate implements EntityInstanceColumn {

  private static final Logger log = Logger.getLogger(BooleanEntityInstanceColumn.class.getName());

  // Properties

  private TableOrView<?> objectInstance;
  private BooleanEntityColumn entityColumn;

  // Constructor

  public BooleanEntityInstanceColumn(final TableOrView<?> objectInstance, final BooleanEntityColumn entityColumn) {
