...
public class DateTimeEntityColumnMetaData extends DateTimeExpression implements EntityColumnMetadata {

  private static final Logger log = Logger.getLogger(DateTimeEntityColumnMetaData.class.getName());
  ...
  public DateTimeEntityColumnMetaData(final String name, final String property, final String type, final Integer columnSize,
