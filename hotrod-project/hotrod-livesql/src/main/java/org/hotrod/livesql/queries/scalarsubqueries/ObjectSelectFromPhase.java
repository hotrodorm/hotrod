...
public class ObjectSelectFromPhase extends ObjectSelectExpression {
  ...
  public ObjectSelectFromPhase join(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
  ...
  public ObjectSelectFromPhase leftJoin(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
  ...
  public ObjectSelectFromPhase rightJoin(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
  ...
  public ObjectSelectFromPhase fullJoin(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
