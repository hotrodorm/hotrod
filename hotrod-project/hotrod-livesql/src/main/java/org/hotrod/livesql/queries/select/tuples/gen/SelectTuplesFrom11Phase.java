...
public class SelectTuplesFrom11Phase<A, B, C, D, E, F, G, H, I, J, K> {
  ...
  SelectTuplesFrom11Phase(final TuplesMetadata metadata) {
    this.metadata = metadata;
  }

  // joining TableOrView

  public <TV extends TableOrView<L>, L> SelectTuplesFrom12Phase<A, B, C, D, E, F, G, H, I, J, K, L> join(TV t, final GeneralBooleanExpression on) {
  ...
  public SelectTuplesFrom11Phase<A, B, C, D, E, F, G, H, I, J, K> join(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom11Phase<A, B, C, D, E, F, G, H, I, J, K> leftJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom11Phase<A, B, C, D, E, F, G, H, I, J, K> rightJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom11Phase<A, B, C, D, E, F, G, H, I, J, K> fullJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple11<A, B, C, D, E, F, G, H, I, J, K>> where(final GeneralBooleanExpression predicate) {
