...
public class ByteArraySelectFromPhase extends ByteArraySelectExpression {
  ...
  ByteArraySelectFromPhase(final UnarySelectObject<Row> select, final TableExpression t) {
    super(select);
  ...
  public ByteArraySelectFromPhase leftJoin(final TableExpression tableViewOrSubquery,
  ...
  public ByteArraySelectFromPhase rightJoin(final TableExpression tableViewOrSubquery,
      final GeneralBooleanExpression on) {
  ...
  public ByteArraySelectFromPhase fullJoin(final TableExpression tableViewOrSubquery,
      final GeneralBooleanExpression on) {
