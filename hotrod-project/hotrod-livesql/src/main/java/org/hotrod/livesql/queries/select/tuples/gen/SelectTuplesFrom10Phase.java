...
public class SelectTuplesFrom10Phase<A, B, C, D, E, F, G, H, I, J> {
  ...
  SelectTuplesFrom10Phase(final TuplesMetadata metadata) {
    this.metadata = metadata;
  }

  // joining TableOrView

  public <TV extends TableOrView<K>, K> SelectTuplesFrom11Phase<A, B, C, D, E, F, G, H, I, J, K> join(TV t, final GeneralBooleanExpression on) {
  ...
  public SelectTuplesFrom10Phase<A, B, C, D, E, F, G, H, I, J> join(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom10Phase<A, B, C, D, E, F, G, H, I, J> leftJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom10Phase<A, B, C, D, E, F, G, H, I, J> rightJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom10Phase<A, B, C, D, E, F, G, H, I, J> fullJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple10<A, B, C, D, E, F, G, H, I, J>> where(final GeneralBooleanExpression predicate) {
