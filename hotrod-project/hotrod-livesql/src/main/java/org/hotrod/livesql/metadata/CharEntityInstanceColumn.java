...
public class CharEntityInstanceColumn extends CharExpression implements EntityInstanceColumn {

  private static final Logger log = Logger.getLogger(CharEntityInstanceColumn.class.getName());

  // Properties

  private TableOrView<?> objectInstance;
  private CharEntityColumn entityColumn;

  // Constructor

  public CharEntityInstanceColumn(final TableOrView<?> objectInstance, final CharEntityColumn entityColumn) {
