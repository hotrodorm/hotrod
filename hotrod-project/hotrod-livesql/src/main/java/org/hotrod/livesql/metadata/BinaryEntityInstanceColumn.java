...
public class BinaryEntityInstanceColumn extends BinaryExpression implements EntityInstanceColumn {

  private static final Logger log = Logger.getLogger(BinaryEntityInstanceColumn.class.getName());

  // Properties

  private TableOrView<?> objectInstance;
  private BinaryEntityColumn entityColumn;

  // Constructor

  public BinaryEntityInstanceColumn(final TableOrView<?> objectInstance, final BinaryEntityColumn entityColumn) {
