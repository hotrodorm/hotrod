...
public class CharEntityColumnMetaData extends CharExpression implements EntityColumnMetadata {
  ...
  public CharEntityColumnMetaData(final String name, final String property, final String type, final Integer columnSize,
