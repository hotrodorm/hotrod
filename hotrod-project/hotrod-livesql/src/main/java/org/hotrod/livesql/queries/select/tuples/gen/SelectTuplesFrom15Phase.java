...
public class SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> {
  ...
  public <TV extends TableOrView<P>, P> SelectTuplesFrom16Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> join(TV t, final BooleanExpression on) {
  ...
  public <TV extends TableOrView<P>, P> SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> semiJoin(TV t, final BooleanExpression on) {
  ...
  public <TV extends TableOrView<P>, P> SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> semiLeftJoin(TV t, final BooleanExpression on) {
  ...
  public <TV extends TableOrView<P>, P> SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> semiRightJoin(TV t, final BooleanExpression on) {
  ...
  public <TV extends TableOrView<P>, P> SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> semiFullJoin(TV t, final BooleanExpression on) {
  ...
  public SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> join(Subquery t, final BooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> leftJoin(Subquery t, final BooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> rightJoin(Subquery t, final BooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom15Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> fullJoin(Subquery t, final BooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>> where(final BooleanExpression predicate) {
