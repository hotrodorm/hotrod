...
public class BooleanEntityColumn extends Predicate implements EntityColumn {
  ...
  private BooleanEntityColumnMetaData entityColumn;

  // Constructor

  public BooleanEntityColumn(final TableOrView<?> objectInstance, final BooleanEntityColumnMetaData entityColumn) {
