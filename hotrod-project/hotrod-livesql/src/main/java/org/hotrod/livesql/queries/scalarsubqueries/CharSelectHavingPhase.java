...
public class CharSelectHavingPhase extends CharSelectExpression {

  // Constructor

  CharSelectHavingPhase(final UnarySelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
    if (predicate != null) {
