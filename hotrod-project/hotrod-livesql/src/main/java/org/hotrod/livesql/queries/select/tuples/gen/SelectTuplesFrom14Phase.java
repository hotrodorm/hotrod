...
public class SelectTuplesFrom14Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N> {
  ...
  public List<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> execute(LiveSQLLogging loggingAdapter) {
    CombinedSelectObject<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.execute(this.metadata.getContext(), loggingAdapter);
  }

  public Cursor<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> executeCursor(LiveSQLLogging loggingAdapter) throws SQLException {
    CombinedSelectObject<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), loggingAdapter);
  }

  public Cursor<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> executeCursor(LiveSQLLogging loggingAdapter, int fetchSize) throws SQLException {
    CombinedSelectObject<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), loggingAdapter, fetchSize);
  }

  public Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> executeOne(LiveSQLLogging loggingAdapter) throws SQLException {
    CombinedSelectObject<Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
