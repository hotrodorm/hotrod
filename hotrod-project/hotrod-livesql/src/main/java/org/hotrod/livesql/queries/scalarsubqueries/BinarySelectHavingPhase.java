...
public class BinarySelectHavingPhase extends BinarySelectExpression {

  // Constructor

  BinarySelectHavingPhase(final UnarySelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
    if (predicate != null) {
