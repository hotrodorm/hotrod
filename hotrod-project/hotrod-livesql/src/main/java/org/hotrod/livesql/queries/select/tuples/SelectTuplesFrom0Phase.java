...
public class SelectTuplesFrom0Phase {
  ...
  public <T extends TableOrView<A>, A> SelectTuplesFrom1Phase<A> join(T t, final GeneralBooleanExpression on) {
  ...
  public <T extends TableOrView<A>, A> SelectTuplesFrom1Phase<A> leftJoin(T t, final GeneralBooleanExpression on) {
  ...
  public <T extends TableOrView<A>, A> SelectTuplesFrom1Phase<A> rightJoin(T t, final GeneralBooleanExpression on) {
  ...
  public <T extends TableOrView<A>, A> SelectTuplesFrom1Phase<A> fullJoin(T t, final GeneralBooleanExpression on) {
  ...
  public SelectTuplesFrom0Phase join(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom0Phase leftJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom0Phase rightJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom0Phase fullJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
