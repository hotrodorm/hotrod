...
public class SelectTuplesFrom7Phase<A, B, C, D, E, F, G> {
  ...
  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> join(T0 t, final Predicate on) {
    this.metadata.join(new InnerJoin(t, on));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> join(T0 t, final EntityColumn... using) {
    this.metadata.join(new InnerJoin(t, using));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> leftJoin(T0 t,
      final Predicate on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> leftJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new LeftOuterJoin(t, using));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> rightJoin(T0 t,
      final Predicate on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> rightJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new RightOuterJoin(t, using));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> fullJoin(T0 t,
      final Predicate on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> fullJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new FullOuterJoin(t, using));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> crossJoin(T0 t) {
    this.metadata.join(new CrossJoin(t));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> naturalJoin(T0 t) {
    this.metadata.join(new NaturalInnerJoin(t));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> naturalLeftJoin(T0 t) {
    this.metadata.join(new NaturalLeftOuterJoin(t));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> naturalRightJoin(T0 t) {
    this.metadata.join(new NaturalRightOuterJoin(t));
    return new SelectTuplesFrom8Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> naturalFullJoin(T0 t) {
  ...
  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiJoin(T0 t, final Predicate on) {
    this.metadata.join(new InnerJoin(t, on), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new InnerJoin(t, using), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiLeftJoin(T0 t, final Predicate on) {
    this.metadata.join(new LeftOuterJoin(t, on), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiLeftJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new LeftOuterJoin(t, using), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiRightJoin(T0 t, final Predicate on) {
    this.metadata.join(new RightOuterJoin(t, on), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiRightJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new RightOuterJoin(t, using), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiFullJoin(T0 t, final Predicate on) {
    this.metadata.join(new FullOuterJoin(t, on), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiFullJoin(T0 t, final EntityColumn... using) {
    this.metadata.join(new FullOuterJoin(t, using), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiCrossJoin(T0 t) {
    this.metadata.join(new CrossJoin(t), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiNaturalJoin(T0 t) {
    this.metadata.join(new NaturalInnerJoin(t), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiNaturalLeftJoin(T0 t) {
    this.metadata.join(new NaturalLeftOuterJoin(t), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiNaturalRightJoin(T0 t) {
    this.metadata.join(new NaturalRightOuterJoin(t), false);
    return new SelectTuplesFrom7Phase<>(this.metadata);
  }

  public <T0 extends TableOrView<H>, H> SelectTuplesFrom7Phase<A, B, C, D, E, F, G> semiNaturalFullJoin(T0 t) {
  ...
  public SelectTuplesFrom7Phase<A, B, C, D, E, F, G> join(Subquery t, final Predicate on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom7Phase<A, B, C, D, E, F, G> leftJoin(Subquery t, final Predicate on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom7Phase<A, B, C, D, E, F, G> rightJoin(Subquery t, final Predicate on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom7Phase<A, B, C, D, E, F, G> fullJoin(Subquery t, final Predicate on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple7<A, B, C, D, E, F, G>> where(final Predicate predicate) {
  ...
  public List<Tuple7<A, B, C, D, E, F, G>> execute(LiveSQLLogging loggingAdapter) {
    CombinedSelectObject<Tuple7<A, B, C, D, E, F, G>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.execute(this.metadata.getContext(), loggingAdapter);
  }

  public Cursor<Tuple7<A, B, C, D, E, F, G>> executeCursor(LiveSQLLogging loggingAdapter) throws SQLException {
    CombinedSelectObject<Tuple7<A, B, C, D, E, F, G>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), loggingAdapter);
  }

  public Cursor<Tuple7<A, B, C, D, E, F, G>> executeCursor(LiveSQLLogging loggingAdapter, int fetchSize) throws SQLException {
    CombinedSelectObject<Tuple7<A, B, C, D, E, F, G>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), loggingAdapter, fetchSize);
  }

  public Tuple7<A, B, C, D, E, F, G> executeOne(LiveSQLLogging loggingAdapter) throws SQLException {
    CombinedSelectObject<Tuple7<A, B, C, D, E, F, G>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
