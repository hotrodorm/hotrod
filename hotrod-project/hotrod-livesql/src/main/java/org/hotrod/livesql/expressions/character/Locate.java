...
public class Locate extends NumericSyntaxExpression {

  private CharExpression substring;
  private CharExpression string;
  private NumericExpression from;

  public Locate(final CharExpression substring, final CharExpression string, final NumericExpression from) {
