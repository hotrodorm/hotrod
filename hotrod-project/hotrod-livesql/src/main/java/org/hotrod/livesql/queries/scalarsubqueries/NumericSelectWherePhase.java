...
public class NumericSelectWherePhase extends NumericSelectExpression {

  // Constructors

  NumericSelectWherePhase(final UnarySelectObject<Row> select, final GeneralBooleanExpression predicate) {
    super(select);
