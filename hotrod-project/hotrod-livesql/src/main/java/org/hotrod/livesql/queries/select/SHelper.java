...
public class SHelper {
  ...
  public static <R> SelectWherePhase<R> getSelectWherePhase(final LiveSQLContext context, final MultiSet<R> select,
  ...
  public static <R> SelectGroupByPhase<R> getSelectGroupByPhase(final LiveSQLContext context, final MultiSet<R> select,
  ...
  public static <R> LockableSelectOrderByPhase<R> getSelectOrderByPhase(final LiveSQLContext context,
      final MultiSet<R> select, final OrderingTerm... orderingTerms) {
    CombinedSelectObject<R> combined = new CombinedSelectObject<R>(select);
  ...
  public static <R> LockableSelectOffsetPhase<R> getSelectOffsetPhase(final LiveSQLContext context,
      final MultiSet<R> select, final int offset) {
    CombinedSelectObject<R> combined = new CombinedSelectObject<R>(select);
  ...
  public static <R> LockableSelectLimitPhase<R> getSelectLimitPhase(final LiveSQLContext context,
      final MultiSet<R> select, final int limit) {
    CombinedSelectObject<R> combined = new CombinedSelectObject<R>(select);
