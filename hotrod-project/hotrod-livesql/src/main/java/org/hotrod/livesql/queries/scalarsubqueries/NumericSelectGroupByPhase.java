...
public class NumericSelectGroupByPhase extends NumericSelectExpression {

  // Constructor

  NumericSelectGroupByPhase(final UnarySelectObject<Row> select, final ComparableExpression... expressions) {
    super(select);
  ...
  public NumericSelectHavingPhase having(final GeneralBooleanExpression predicate) {
    return new NumericSelectHavingPhase(this.select, predicate);
  }
