...
public class BooleanSelectFromPhase extends BooleanSelectExpression {
  ...
  public BooleanSelectFromPhase join(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
    this.select.addJoin(new InnerJoin(tableViewOrSubquery, on));
    return this;
  }

  public BooleanSelectFromPhase join(final TableExpression tableViewOrSubquery, final EntityColumn... using) {
    this.select.addJoin(new InnerJoin(tableViewOrSubquery, using));
    return this;
  }

  public BooleanSelectFromPhase leftJoin(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
    this.select.addJoin(new LeftOuterJoin(tableViewOrSubquery, on));
    return this;
  }

  public BooleanSelectFromPhase leftJoin(final TableExpression tableViewOrSubquery, final EntityColumn... using) {
  ...
  public BooleanSelectFromPhase rightJoin(final TableExpression tableViewOrSubquery, final EntityColumn... using) {
    this.select.addJoin(new RightOuterJoin(tableViewOrSubquery, using));
    return this;
  }

  public BooleanSelectFromPhase fullJoin(final TableExpression tableViewOrSubquery, final GeneralBooleanExpression on) {
    this.select.addJoin(new FullOuterJoin(tableViewOrSubquery, on));
    return this;
  }

  public BooleanSelectFromPhase fullJoin(final TableExpression tableViewOrSubquery, final EntityColumn... using) {
  ...
  public BooleanSelectWherePhase where(final GeneralBooleanExpression predicate) {
