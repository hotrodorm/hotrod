...
public class BooleanSelectFromPhase extends BooleanSelectExpression {
  ...
  public BooleanSelectFromPhase join(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
  ...
  public BooleanSelectFromPhase leftJoin(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
  ...
  public BooleanSelectFromPhase rightJoin(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
  ...
  public BooleanSelectFromPhase fullJoin(final TableExpression tableViewOrSubquery, final EntityColumnMetadata... using) {
