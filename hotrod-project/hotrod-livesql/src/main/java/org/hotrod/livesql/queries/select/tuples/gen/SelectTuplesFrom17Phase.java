...
public class SelectTuplesFrom17Phase<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> {
  ...
  public List<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> execute(LiveSQLLogging liveSQLLogging) {
    CombinedSelectObject<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.execute(this.metadata.getContext(), liveSQLLogging);
  }

  public Cursor<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> executeCursor(LiveSQLLogging liveSQLLogging) throws SQLException {
    CombinedSelectObject<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), liveSQLLogging);
  }

  public Cursor<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> executeCursor(LiveSQLLogging liveSQLLogging, int fetchSize) throws SQLException {
    CombinedSelectObject<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), liveSQLLogging, fetchSize);
  }

  public Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> executeOne(LiveSQLLogging liveSQLLogging) throws SQLException {
    CombinedSelectObject<Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
