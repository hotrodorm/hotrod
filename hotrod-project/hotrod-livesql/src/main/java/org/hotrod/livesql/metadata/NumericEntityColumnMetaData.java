...
public class NumericEntityColumnMetaData extends NumericExpression implements EntityColumnMetadata {

  private static final Logger log = Logger.getLogger(NumericEntityColumnMetaData.class.getName());
  ...
  public NumericEntityColumnMetaData(final String name, final String property, final String type, final Integer columnSize,
