...
public class CharSelectGroupByPhase extends CharSelectExpression {
  ...
  CharSelectGroupByPhase(final UnarySelectObject<Row> select, final ComparableExpression... expressions) {
    super(select);
  ...
  public CharSelectHavingPhase having(final GeneralBooleanExpression predicate) {
