...
public abstract class ObjectFunction extends ObjectSyntaxExpression {

  private FunctionTemplate template;

  protected ObjectFunction(final String pattern, final ComparableExpression... parameters) {
