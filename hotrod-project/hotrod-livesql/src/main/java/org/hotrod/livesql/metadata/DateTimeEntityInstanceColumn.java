...
public class DateTimeEntityInstanceColumn extends DateTimeExpression implements EntityInstanceColumn {

  private static final Logger log = Logger.getLogger(DateTimeEntityInstanceColumn.class.getName());

  // Properties

  private TableOrView<?> objectInstance;
  private DateTimeEntityColumn entityColumn;

  // Constructor

  public DateTimeEntityInstanceColumn(final TableOrView<?> objectInstance, final DateTimeEntityColumn entityColumn) {
