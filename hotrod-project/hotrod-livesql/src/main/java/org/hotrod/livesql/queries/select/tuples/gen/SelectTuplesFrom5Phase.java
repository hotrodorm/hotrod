...
public class SelectTuplesFrom5Phase<A, B, C, D, E> {
  ...
  SelectTuplesFrom5Phase(final TuplesMetadata metadata) {
    this.metadata = metadata;
  }

  // joining TableOrView

  public <TV extends TableOrView<F>, F> SelectTuplesFrom6Phase<A, B, C, D, E, F> join(TV t, final GeneralBooleanExpression on) {
  ...
  public SelectTuplesFrom5Phase<A, B, C, D, E> join(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom5Phase<A, B, C, D, E> leftJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom5Phase<A, B, C, D, E> rightJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom5Phase<A, B, C, D, E> fullJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple5<A, B, C, D, E>> where(final GeneralBooleanExpression predicate) {
