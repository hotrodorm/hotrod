...
public class SelectTuplesFrom12Phase<A, B, C, D, E, F, G, H, I, J, K, L> {
  ...
  public <TV extends TableOrView<M>, M> SelectTuplesFrom13Phase<A, B, C, D, E, F, G, H, I, J, K, L, M> join(TV t, final GeneralBooleanExpression on) {
  ...
  public SelectTuplesFrom12Phase<A, B, C, D, E, F, G, H, I, J, K, L> join(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom12Phase<A, B, C, D, E, F, G, H, I, J, K, L> leftJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom12Phase<A, B, C, D, E, F, G, H, I, J, K, L> rightJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom12Phase<A, B, C, D, E, F, G, H, I, J, K, L> fullJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple12<A, B, C, D, E, F, G, H, I, J, K, L>> where(final GeneralBooleanExpression predicate) {
