...
public class SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> {
  ...
  public List<Tuple8<A, B, C, D, E, F, G, H>> execute(LiveSQLLogging liveSQLLogging) {
    CombinedSelectObject<Tuple8<A, B, C, D, E, F, G, H>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.execute(this.metadata.getContext(), liveSQLLogging);
  }

  public Cursor<Tuple8<A, B, C, D, E, F, G, H>> executeCursor(LiveSQLLogging liveSQLLogging) throws SQLException {
    CombinedSelectObject<Tuple8<A, B, C, D, E, F, G, H>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), liveSQLLogging);
  }

  public Cursor<Tuple8<A, B, C, D, E, F, G, H>> executeCursor(LiveSQLLogging liveSQLLogging, int fetchSize) throws SQLException {
    CombinedSelectObject<Tuple8<A, B, C, D, E, F, G, H>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
    return combined.executeCursor(this.metadata.getContext(), liveSQLLogging, fetchSize);
  }

  public Tuple8<A, B, C, D, E, F, G, H> executeOne(LiveSQLLogging liveSQLLogging) throws SQLException {
    CombinedSelectObject<Tuple8<A, B, C, D, E, F, G, H>> combined = new CombinedSelectObject<>(new TuplesSelectObject<>(this.metadata));
