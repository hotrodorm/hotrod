...
public class SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> {
  ...
  SelectTuplesFrom8Phase(final TuplesMetadata metadata) {
    this.metadata = metadata;
  }

  // joining TableOrView

  public <TV extends TableOrView<I>, I> SelectTuplesFrom9Phase<A, B, C, D, E, F, G, H, I> join(TV t, final GeneralBooleanExpression on) {
  ...
  public SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> join(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new InnerJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> leftJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new LeftOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> rightJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new RightOuterJoin(t, on));
    return this;
  }
  ...
  public SelectTuplesFrom8Phase<A, B, C, D, E, F, G, H> fullJoin(Subquery t, final GeneralBooleanExpression on) {
    this.metadata.join(new FullOuterJoin(t, on));
    return this;
  }
  ...
  public SelectWherePhase<Tuple8<A, B, C, D, E, F, G, H>> where(final GeneralBooleanExpression predicate) {
