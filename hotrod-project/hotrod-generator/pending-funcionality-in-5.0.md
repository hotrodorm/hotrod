...
|:-- |:-- |:--:| -- |
| CRUD | Migrated to plain JDBC | Existing | Completed |
...
| LiveSQL | LiveSQL migrated to plain JDBC | Existing | Completed |
...
| Nitro | Migrated to plain JDBC including Dynamic SQL | Existing | Completed |
...
| Generator | MyBatis fully removed | Removed | Completed |
