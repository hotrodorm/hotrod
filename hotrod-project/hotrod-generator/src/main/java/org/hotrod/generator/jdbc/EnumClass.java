...
public class EnumClass {
  ...
  private ClassPackage enumPackage;

  private ClassWriter w;

  // Constructor

  public EnumClass(final EnumDataSetMetadata metadata, final JDBCTag jdbcTag, final Generator generator) {
    log.fine("init");
    ...
    this.fragmentPackage = this.fragmentConfig != null && this.fragmentConfig.getFragmentPackage() != null
        ...
        : null;
    this.enumPackage = this.jdbcTag.getLayoutPackage(this.fragmentPackage);
  }
  ...
  public void generate(final FileGenerator fileGenerator) throws UncontrolledException, ControlledException {
    ...
    try (TextWriter tw = fileGenerator.createWriter(ec)) {
      ...
      this.w = new ClassWriter(this.enumPackage, "// Autogenerated by " + Constants.TOOL_NAME + " -- Do not edit.", "");
      this.writeBody();
      w.writeTo(tw);
  ...
  public String getFullClassName() {
    return this.enumPackage.getFullClassName(this.getClassName());
  }
