...
public abstract class EnhancedSQLPart extends AbstractConfigurationTag {
  ...
  public abstract void validate(final DaosSpringMyBatisTag daosTag, final HotRodConfigTag config,
  ...
  public abstract void validateAgainstDatabase(final Generator generator)
