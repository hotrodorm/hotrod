...
public class AutoGeneratedColumnTag extends AbstractConfigurationTag {
  ...
  public void validateAgainstDatabase(final Metadata metadata, final JdbcTable t)
    ...
    if (this.jdbcColumn == null) {
      throw new InvalidConfigurationFileException(this, "Could not find database column '" + this.name + "' on table '"
          + name + "' as specified in the attribute 'name' of the tag <" + super.getTagName() + ">.");
    }
