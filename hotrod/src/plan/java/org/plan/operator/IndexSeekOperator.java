...
public class IndexSeekOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "INDEX SEEK";

  public IndexSeekOperator(final T id, final String specificName, final SourceSet sourceSet,
