...
public class MergeJoinOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "MERGE JOIN";

  public MergeJoinOperator(final T id, final String operatorName, final SourceSet sourceSet,
