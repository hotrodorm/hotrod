...
public class GroupAggregateOperator extends Operator {

  public GroupAggregateOperator(final String id, final String operatorName, final boolean includesFetch,
