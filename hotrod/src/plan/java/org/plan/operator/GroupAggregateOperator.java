...
public class GroupAggregateOperator<T extends Comparable<T>> extends Operator<T> {

  public GroupAggregateOperator(final T id, final String operatorName, final SourceSet sourceSet,
