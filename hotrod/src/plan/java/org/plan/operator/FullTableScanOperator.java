...
public class FullTableScanOperator<T extends Comparable<T>> extends Operator<T> {

  public FullTableScanOperator(final T id, final String operatorName, final SourceSet sourceSet,
