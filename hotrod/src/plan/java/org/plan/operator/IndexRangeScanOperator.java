...
public class IndexRangeScanOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "INDEX RANGE SCAN";

  public IndexRangeScanOperator(final T id, final String operatorName, final SourceSet sourceSet,
