...
public class HashAggregateOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "HASH AGGREGATE";

  public HashAggregateOperator(final T id, final String specificName, final SourceSet sourceSet,
