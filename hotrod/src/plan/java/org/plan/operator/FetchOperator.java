...
public class FetchOperator<T extends Comparable<T>> extends Operator<T> {

  public FetchOperator(final T id, final String operatorName, final SourceSet sourceSet,
