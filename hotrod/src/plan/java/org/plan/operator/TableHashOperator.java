...
public class TableHashOperator<T extends Comparable<T>> extends Operator<T> {

  private static final String NAME = "TABLE HASH";

  public TableHashOperator(final T id, final String operatorName, final SourceSet sourceSet,
