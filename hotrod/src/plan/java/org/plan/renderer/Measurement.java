...
public class Measurement {
  ...
  public Measurement(final double minWidth, final double maxWidth) {

    if (minWidth < 0.001) {
      throw new IllegalArgumentException("minWidth must be greater than 0.001");
    }
    if (maxWidth < 0.001) {
      throw new IllegalArgumentException("maxWidth must be greater than 0.001");
    }
    ...
    this.rows = new Range(ROWS_EXP, this.minWidth, this.maxWidth, ROWS_MIN_COLOR, ROWS_MAX_COLOR);
