...
public class MyBatisGenerator extends HotRodGenerator {
  ...
  private LinkedHashMap<EnumMetadata, EnumClass> enumClasses = new LinkedHashMap<EnumMetadata, EnumClass>();
  ...
  public void prepareGeneration() throws UncontrolledException, ControlledException {
    ...
    for (EnumMetadata em : this.enums) {
      this.enumClasses.put(em, new EnumClass(em, this.myBatisTag.getDaos(), this));
    }
  ...
  private void addDaosAndMapper(final DataSetMetadata metadata, final DAOType type) throws ControlledException {
    ...
    case TABLE:
      ...
      abstractVO = new ObjectAbstractVO(metadata, layout, DAOType.TABLE, myBatisTag);
      vo = new ObjectVO(metadata, layout, abstractVO, myBatisTag);
    ...
    case VIEW:
      ...
      abstractVO = new ObjectAbstractVO(metadata, layout, DAOType.VIEW, myBatisTag);
      vo = new ObjectVO(metadata, layout, abstractVO, myBatisTag);
  ...
  private void addDaosAndMapper(final SelectDataSetMetadata metadata) throws ControlledException {
    ...
    abstractVO = new ObjectAbstractVO(metadata, layout, DAOType.SELECT, myBatisTag);
    vo = new ObjectVO(metadata, layout, abstractVO, myBatisTag);
