...
public class Mapper {
  ...
  public Mapper(final AbstractCompositeDAOTag compositeTag, final DataSetMetadata metadata, final DataSetLayout layout,
      final HotRodGenerator generator, final DAOType type, final DatabaseAdapter adapter, final ObjectVO vo) {
    log.debug("init");
  ...
  private void initialize(final DataSetMetadata metadata, final DataSetLayout layout, final HotRodGenerator generator,
