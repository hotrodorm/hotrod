...
public class SelectAbstractVO {
  ...
  // From a solo VO
  public SelectAbstractVO(final SelectVOClass soloVO, final DataSetLayout layout, final MyBatisSpringTag myBatisTag) {
    log.debug("init");
  ...
  // From a connected VO
  public SelectAbstractVO(final VOMetadata vo, final DataSetLayout layout, final MyBatisSpringTag myBatisTag) {
    this.myBatisTag = myBatisTag;
    this.layout = layout;
