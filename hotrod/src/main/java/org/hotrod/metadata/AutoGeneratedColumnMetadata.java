...
public class AutoGeneratedColumnMetadata {
  ...
  public AutoGeneratedColumnMetadata(final DataSetMetadata dataSet, final AutoGeneratedColumnTag tag,
    ...
    this.columnMetadata = new ColumnMetadata(tag.getJdbcColumn(), this.adapter, null, false);
  }
  ...
  public boolean useIdentityGeneratedKeys() {
    return this.adapter.useIdentityGeneratedKeysOnInsert();
  }
