  ...
  public void validateAgainstDatabase(final JdbcDatabase db, final DatabaseAdapter adapter)
    ...
    if (this.autoGeneratedColumn != null) {
      ...
      if (this.sequence != null) {
        ...
        this.autoGeneratedColumn.setAutogenerationType(null);
        ...
        if (jt.getPk() != null && jt.getPk().getKeyColumns().size() == 1) {
          JdbcColumn jc = jt.getPk().getKeyColumns().get(0).getColumn();
          if (jc.getAutogenerationType() != AutogenerationType.IDENTITY_ALWAYS
              || jc.getAutogenerationType() != AutogenerationType.IDENTITY_BY_DEFAULT) {

            this.autoGeneratedColumn = new AutoGeneratedColumnTag();
            this.autoGeneratedColumn.setName(jc.getName());
            this.autoGeneratedColumn.setSequence(null);
            this.autoGeneratedColumn
                .setAlways(jc.getAutogenerationType() == AutogenerationType.IDENTITY_ALWAYS ? "true" : "false");
            this.autoGeneratedColumn.setJdbcTable(jt);
            this.autoGeneratedColumn.setJdbcColumn(jc);
            this.autoGeneratedColumn.setAutogenerationType(jc.getAutogenerationType());
