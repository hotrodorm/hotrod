...
public class AutoGeneratedColumnTag extends AbstractConfigurationTag {
  ...
  private static final Logger log = Logger.getLogger(AutoGeneratedColumnTag.class);
  ...
  public void validateAgainstDatabase(final HotRodGenerator generator, final String name)
      throws InvalidConfigurationFileException {

    this.jdbcTable = generator.findJdbcTable(name);
    if (this.jdbcTable == null) {
      throw new InvalidConfigurationFileException(this, //
          "Could not find database table '" + name + "'", //
          "Could not find database table '" + name + "' as specified in the attribute 'name' of the tag <"
              + new TableTag().getTagName() + ">.");
    }
