...
public class AutoGeneratedColumnTag {

  private static final String TAG_NAME = "auto-generated-key";
  ...
  public void validate() throws InvalidConfigurationFileException {
    ...
    if (this.sequence == null) {
      ...
      if (this.sAllowsSpecifiedValue == null) {
        ...
        throw new InvalidConfigurationFileException("Invalid attribute 'allows-specified-value' of the tag <" + TAG_NAME
            + ">: valid values are '" + ALLOWS_SPECIFIED_VALUE_TRUE + "' or '" + ALLOWS_SPECIFIED_VALUE_FALSE
            + "' (defaults to '" + ALLOWS_SPECIFIED_VALUE_FALSE + "')");
      }
      ...
      if (SUtils.isEmpty(this.sequence)) {
        throw new InvalidConfigurationFileException(
            "When specified, the attribute 'sequence' of the tag <" + TAG_NAME + "> cannot be empty. "
  ...
  public void validateAgainstDatabase(final JdbcDatabase db, final DatabaseAdapter adapter, final String name)
    ...
    if (this.jdbcTable == null) {
      throw new InvalidConfigurationFileException("Could not find table '" + name
          + "' as specified in the attribute 'name' of the tag <" + TableTag.TAG_NAME + ">.");
    }
    ...
    if (this.jdbcColumn == null) {
      throw new InvalidConfigurationFileException("Could not find database column '" + this.name + "' on table '" + name
          + "' as specified in the attribute 'name' of the tag <" + TAG_NAME + ">.");
    }
