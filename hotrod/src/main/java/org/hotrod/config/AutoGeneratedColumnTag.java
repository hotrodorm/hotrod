...
public class AutoGeneratedColumnTag extends AbstractConfigurationTag {
  ...
  public void validate() throws InvalidConfigurationFileException {
    ...
    if (SUtils.isEmpty(this.name)) {
      throw new InvalidConfigurationFileException(super.getSourceLocation(), "Attribute 'name' of tag <"
          + super.getTagName() + "> cannot be empty. " + "Must specify the auto-generated column name.");
    }
    ...
    if (this.sequence == null) {
      ...
      if (this.sAllowsSpecifiedValue == null) {
        ...
        throw new InvalidConfigurationFileException(super.getSourceLocation(),
            "Invalid attribute 'allows-specified-value' of the tag <" + super.getTagName() + ">: valid values are '"
                + ALLOWS_SPECIFIED_VALUE_TRUE + "' or '" + ALLOWS_SPECIFIED_VALUE_FALSE + "' (defaults to '"
                + ALLOWS_SPECIFIED_VALUE_FALSE + "')");
      }
      ...
      if (this.sAllowsSpecifiedValue != null) {
        throw new InvalidConfigurationFileException(super.getSourceLocation(),
            "Invalid attribute 'allows-specified-value' of the tag <" + super.getTagName()
  ...
  public void validateAgainstDatabase(final JdbcDatabase db, final DatabaseAdapter adapter, final String name)
    ...
    if (this.jdbcTable == null) {
      throw new InvalidConfigurationFileException(super.getSourceLocation(), "Could not find table '" + name
