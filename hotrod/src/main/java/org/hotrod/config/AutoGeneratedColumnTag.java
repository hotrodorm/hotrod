...
public class AutoGeneratedColumnTag extends AbstractConfigurationTag {
  ...
  void setIdentityType(final IdentityType identityType) {
  ...
  public void validate() throws InvalidConfigurationFileException {
    ...
    if (this.sequence == null) { // identity
      ...
      if (this.always == null) {
        this.identityType = IdentityType.ALWAYS;
      } else if (ALWAYS_TRUE.equals(this.always) || ALWAYS_FALSE.equals(this.always)) {
        this.identityType = ALWAYS_TRUE.equals(this.always) ? IdentityType.ALWAYS : IdentityType.BY_DEFAULT;
      } else {
