...
public class MySQLAdapter extends DatabaseAdapter {
  ...
  // "Sequence based auto-generated key is not supported in MySQL DB. " + "The
  // table '"
  // + agcm.getDataSet().getIdentifier().getSQLIdentifier() + "' specifies the
  // sequence attribute with value '"
  // + agcm.getSequence() + "' but sequences are not supported by MySQL
  // database.");
  // }
  // return "select @@identity";
  // }
