...
public class SAPASEAdapter extends DatabaseAdapter {
  ...
  // "Sequence based auto-generated key is not supported in Sybase DB. " +
  // "Identity auto-generated keys are; "
  ...
  // throw new SequencesNotSupportedException("Cannot provide sequence values
  // for sequence '"
  // + identifier.getSQLIdentifier() + "' from tag <sequence>; sequences are not
