...
public class XMLLoader2 {
  ...
  private static final File dir = new File("testdata/xsd-parser/case002");
  ...
  public void parse() throws JAXBException, MalformedURLException, SAXException {
    ...
    JAXBContext context = JAXBContext.newInstance(FirstName.class);
    ...
    FirstName bean = (FirstName) unmarshaller.unmarshal(f);
