...
public class XMLLoader5 {

  private static final File dir = new File("testdata/xsd-parser/case005");
  ...
  public void parse() throws JAXBException, MalformedURLException, SAXException {
    ...
    JAXBContext context = JAXBContext.newInstance(ShoeSize.class);
    ...
    ShoeSize bean = (ShoeSize) unmarshaller.unmarshal(f);
