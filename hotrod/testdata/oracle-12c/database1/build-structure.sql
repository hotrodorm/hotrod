...
create table account (
  id number(9) generated always as identity not null,
  name varchar2(20) not null,
...
create table transaction (
  ...
  seq_id number(9) generated by default as identity not null,
...
create table test_identity1 (
  id number(9) generated by default as identity not null,
  name varchar(40) not null
);

alter table test_identity1 modify (id generated by default as identity start with 50);
...
alter table test_identity1 modify (id generated by default as identity start with 70);
...
alter table test_seq_ide_def1 modify (id generated by default as identity start with 90);
