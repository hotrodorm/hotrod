...
import hotrod.test.generation.TypesPseudo1DAO;
import hotrod.test.generation.TypesPseudo2DAO;
...
public class TypesTest {
  ...
  private static void testTypes() throws SQLException {
    ...
    for (TypesPseudo1DAO x : TypesPseudo1DAO.selectByExample(new TypesPseudo1DAO())) {
      System.out.println("pseudo1=" + x);
    }

    // Pseudo 1

    for (TypesPseudo2DAO x : TypesPseudo2DAO.selectByExample(new TypesPseudo2DAO())) {
